...
function calFooter() {
  return "<tr bgcolor='"+footColor+"'><td colspan='7' align='center'>"+span1(footColor)+"<b><a href='javascript:hideCal()' style='text-decoration:none; color:"+footFontColor+";'>[cerrar]</a>&nbsp;&nbsp;<a href='javascript:clearDate()' style='text-decoration:none; color:"+footFontColor+";'>[limpiar]</a></b>"+span2+"</td></tr></table></td></tr></table>";
}
...
function showCal(name) {
  ...
  if (currentCal != null) {
    ...
    alert("Calendario ["+name+"] no encontrado");
  }
}

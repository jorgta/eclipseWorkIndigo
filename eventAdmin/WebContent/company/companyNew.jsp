...
<BODY>
	...
	<H1> <bean:message key="label.company.new" />  </H1>
	...
	<logic:present name="beanUser" scope="session">
		  ...
		  <logic:present name="processList" scope="session">
			...
			<html:form action="/companyNew" enctype="multipart/form-data">
			<TABLE border="0" ALIGN="CENTER">
				<TBODY>
					...
					<TR>
						...
						<TD><html:text property="fullname" size="60"></html:text></TD>
					...
					<TR>
					<TR>
						<TD><bean:message key="label.company.webSite" /></TD>
						<TD><html:text property="web_site" size="80"></html:text></TD>
		       			<TD> <FONT COLOR="RED"> <html:errors property="web_site"/></FONT> 
					<TR>
			...
			<CENTER><P><html:submit> <bean:message key="label.register" /> </html:submit></P></CENTER>			
			<CENTER><P><html:button property="finish" onclick="location='/eventAdmin/main.jsp';"> <bean:message key="label.finish" /> </html:button> </P></CENTER>			

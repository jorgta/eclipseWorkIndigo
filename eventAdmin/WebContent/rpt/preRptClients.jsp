...
<BODY>
	...
	<logic:present name="beanUser" scope="session">
		  ...
		  <logic:present name="processList" scope="session">
			...
			<TABLE border="0" ALIGN="CENTER" class="table_campo">
				<TBODY>
					<TR>
						<TD><bean:message key="label.since" /></TD>
						<TD><html:text property="since"></html:text></TD>
					</TR>
					<TR>
						<TD><bean:message key="label.until" /></TD>
						<TD><html:text property="until"></html:text></TD>
					</TR>
					<TR  align="center">
						<TD colspan="2">
					...
					<TR align="center">
					    <TD colspan="2"><html:submit ><bean:message key="label.select" /></html:submit>

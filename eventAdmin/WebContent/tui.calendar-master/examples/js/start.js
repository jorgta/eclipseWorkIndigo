...
(function(window, Calendar) {
    ...
    var ajaxInformation= new AjaxInformation();
    ajaxInformation.ajaxurl = "Calendar";
    ajaxInformation.hosturl = "http://localhost:8080/eventAdmin/"
    ajaxInformation.data = {'bean': 'BeanOptionsCalendar','active':'Y','orderField':'id',  'listName':'CalendarInfoList','proccess':'getinfo' }

    var objList = [];
    var calendar;
    var id = 0;
    
    $.ajax({url: ajaxInformation.hosturl + ajaxInformation.ajaxurl, 
    async:false,
    cache: false,
    type: 'POST',
    datatype:"json",
    ...
    success: function(result){
       ...
       for (var i = 0; i < objList.length; i++) {
        ...
        if(item.setdefault == 'Y' )
        {
            useCreationPopup = (item.useCreationPopup == 'true');
            useDetailPopup = ( item.useDetailPopup == 'true');
    ...
    cal = new Calendar('#calendar', {
        ...
        template: {
            ...
            task: function(schedule) {
             ...
             taskTitle: function() {
             return '<span class="tui-full-calendar-left-content">Tare</span>';
             },
            ...
            popupDetailLocation: function(schedule) {
                return 'Locación : ' + schedule.location;
              },
    ...
    function saveNewSchedule(scheduleData) {
        ...
        schedule.id=resltJsonString.guid;
        cal.createSchedules([schedule]);

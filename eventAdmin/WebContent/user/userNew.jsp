		  ...
		  <logic:present name="processList" scope="session">
			...
			<div class="card  mb-3"  >
			  ...
			  <div class="card-body">
			    ...
			    <h5 class="card-title"><bean:message key="label.client.header" /> </h5>
			    <p class="card-text">
						 ...
						 <ul class="list-group">				 
								 ...
								 <li class="list-group-item">
								    ...
								    <div class="form-group">
								      <label class="control-label col-sm-3" for="name"><bean:message key="label.name" />:</label>
								      <div class="col-sm-5">								     
								    ...
								    <div class="form-group">
								      <label class="control-label col-sm-2" for="password"><bean:message key="label.password" />:</label>
								      <div class="col-sm-5"> 								          
								        <html:text property="password" size="60" styleClass="form-control"  ></html:text>
								         <div class="col-sm-6">
								     ...
								     <div class="form-group">
								      <label class="control-label col-sm-2" for="email"><bean:message key="label.email" />:</label>
								      <div class="col-sm-5">          
								    ...
								    <div class="form-group">        
								      <div class="col-sm-offset-2 col-sm-10">
								        <button type="submit" class="btn btn-secondary"><bean:message key="label.register" />  </button>
								      </div>
								    </div>
								</li>

		  ...
		  <logic:present name="processList" scope="session">
			  <%
		        ...
		        if ( found == 0 )
		         ...
		         String sclString;
		         String sdeString;
		         BeanSale beanSale= (BeanSale)ses.getAttribute("selectedSale"); 
		         if ( beanSale != null ) 
		         {
		        	 sidString = new Integer( beanSale.getId() ).toString(); 
		        	 sclString = beanSale.getClient_name();
		        	 sdeString = beanSale.getDate_event().toString();
					...
					<html:hidden property="id_sale" value=""/>	
						...
						<div class="form-row">
						    <div class="col-md-4 mb-3">								      
						      <label for="id_quote"><bean:message key="label.sale.number" /></label>								      	      
						       	
						      <input type="text" value="<%=sidString%>"  disabled="true"  class="form-control"  />					      			      
						    ...
						    <div class="col-md-4 mb-3">								      
						      ...
						      <input type="text" value="<%=sclString%>"  disabled="true"  class="form-control"  />					      			      
						      <FONT COLOR="RED"> <html:errors property="id_quote"/></FONT> 
						    </div>
						    ...
						    <div class="col-md-4 mb-3">								      
						      ...
						      <input type="text" value="<%=sdeString%>"  disabled="true"  class="form-control"  />					      			      
						      <FONT COLOR="RED"> <html:errors property="id_quote"/></FONT> 
						    </div>						 
					    </div>			    
					    <div class="form-row">

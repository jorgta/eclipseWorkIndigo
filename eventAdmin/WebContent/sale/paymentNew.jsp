		  ...
		  <logic:present name="processList" scope="session">
		      ...
		      //campos para ignorar en el gridview
				...
				*/
				...
				//nombre de la forma
				String formName="paymentNewForm";
				    ...
				    <p class="card-text">
							 ...
							 <table  class="HeaderStyle" cellspacing="0" border="1" id="GridView1" style="border-collapse:collapse; ">
							   ...
							   <div class="table-responsive-sm">	 
				                <table  class="HeaderStyle" cellspacing="0"  border="1"   style="border-collapse:collapse; ">
									  <tr id="HeaderStyle" class="HeaderStyle">
			  							 											
										<td scope="col"><a href="javascript:__doPostBack('GridView1','Sort$CompanyName')">Fecha</a></td>
										<td scope="col"><a href="javascript:__doPostBack('GridView1','Sort$City')">Tipo de pago</a></th>												
										<td scope="col"><a href="javascript:__doPostBack('GridView1','Sort$City')">Abono</a></th>
										<td scope="col"><a href="javascript:__doPostBack('GridView1','Sort$Address')">Adeudo Actual</a></td>
										 ...
										 <logic:iterate id="id" indexId="indexId" name="paymentsRecordList" scope="session" >   	 
									    		 <%
							    			      ...
							    			      <tr class="<%=clase%>">
														...
														<td><bean:write name="id" property="pay_type" /></td>
									...
									<li class="list-group-item ">
										<div class="form-row">						 
										    <div class="col-md-2 mb-3">	
											    <label for="id_hour"><bean:message key="label.date" /></label>	
										    	<div class="input-group">							    	 
									 			<html:hidden property="date_reg"  />
											 ...
											 <div class="col-md-2 mb-3">								      
										      <label for="id_type_payment"><bean:message key="label.type.pay" /></label>	
										      <div class="input-group">							      	      
								   				  <html:select property="id_type_payment" styleClass="form-control">						
											...
											<FONT COLOR="RED"> <html:errors property="id_type_payment"/></FONT>						      			      
										    </div>	
										    
										    
										    
										 	<div class="col-md-2 mb-3">								      
										      <label for="id_payment_type_form"><bean:message key="label.type.pay.form" /></label>	
										      <div class="input-group">							      	      
									   		    <html:select property="id_payment_type_form" styleClass="form-control">						
											...
											<FONT COLOR="RED"> <html:errors property="id_payment_type_form"/></FONT>						      			      
										    </div>	 
										    ...
										    <div class="col-md-2 mb-3">								      
										      <label for="quantity"><bean:message key="label.quantity" /></label>		
										      <div class="input-group">							      	      
									   		    	<html:text property="quantity" styleClass="form-control"></html:text>								      			      
											        <FONT COLOR="RED"> <html:errors property="quantity"/></FONT> 	
											  </div>		
											<div class="input-group-append">
												   <button type="submit" class="btn btn-secondary" onclick="process.value='payItMyAccount';"><bean:message key="label.register" />  </button>
										    </div>			
											<FONT COLOR="RED"> <html:errors property="quantity"/></FONT>						      			      
										    </div>	
									   ...
									   <div class="form-row">
										    	...
										    	<label for=""><bean:message key="label.total" /></label>	
												<div class="input-group-append">												   
												  <label for=""><%out.write(String.valueOf( total));%></label>	
												 </div>
										     </div>				    					 
								      </div>

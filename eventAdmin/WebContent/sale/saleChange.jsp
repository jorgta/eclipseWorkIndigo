	...
	<logic:present name="beanUser" scope="session">
		  ...
		  <logic:present name="processList" scope="session">
			  <%
				...
				ses.setAttribute( "from","saleChange" );		
		      ...
		      //campos para ignorar en el gridview
				...
				*/
				...
				//nombre de la forma
				String formName="saleChangeForm";
				  ...
				  <div class="card-body">
				    ...
				    <a href="#" class="btn btn-primary">Go somewhere</a>
				     -->
							 ...
							 <html:form action="/saleChange"  styleClass="needs-validation">
							 <html:hidden property="process" value=""/>  
							 <html:hidden property="id_sale" value=""/>					 
							...
							%>
								...
								<div class="form-row">						 
								    <div class="col-md-4 mb-3">	
									    <label for="total"><bean:message key="label.client.name" /></label>
							   	...
							   	<div class="form-row">						 
								    <div class="col-md-4 mb-3">	
									    <label for="id_client"><bean:message key="label.client.number" /></label>
								    	<div class="input-group">								    	 
								    	<html:text property="id_client" value='<%=clientNumber%>' size="15" disabled="true" styleClass="form-control"></html:text>
								  ...
								  <div class="form-row">						 
								    <div class="col-md-4 mb-3">	
								    	...
								    	<div class="input-group">								    	 
								    	<!--  
								    	<html:text property="date_event"  styleClass="form-control"></html:text>
									    ...
									    <FONT COLOR="RED"> <html:errors property="date_event"/></FONT>
							 			...
							 			<html:hidden property="date_event"  />
							 			
										<div class="input-group date"  data-target-input="nearest">
						                   
						                     <input type="text" readonly="true" class="form-control datetimepicker-input" id="datetimepicker4" data-toggle="datetimepicker" data-target="#datetimepicker4"/>
							   ...
							   <logic:present name="qnCarListProduct" scope="session">	
							    ...
							    <div class="form-row">						 
							   	...
							   	<div class="form-row">						 
								    <div class="col-md-4 mb-3">	
										<div class="input-group-append">
										   <button type="submit" class="btn btn-secondary" onclick="process.value='register';"><bean:message key="label.register" />  </button>

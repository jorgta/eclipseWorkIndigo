...
import com.eventAdmin.forms.AvailabilitySaloonEventTypeForm;
				...
				if(availabilitySaloonEventTypeForm.getProcess().equals("showCalendar"))
				  {
					...
					//TODO: tomar en cuenta la fecha como parametro
					...
					//String date = Utils.DateToStrInv(new Date(availabilitySaloonEventTypeForm.getDate_event()));
					
					String str_date=availabilitySaloonEventTypeForm.getDate_event();
				    if(availabilitySaloonEventTypeForm.getDate_event() != "")
				    {
					  Date date = new SimpleDateFormat("dd/MM/yyyy").parse(availabilitySaloonEventTypeForm.getDate_event());
					  String formattedDate = new SimpleDateFormat("yyyy/MM/dd").format(date);
					  httpSession.setAttribute("date_event", date );
					  
					  query = query + " AND u.date_event = '" + formattedDate +"'";

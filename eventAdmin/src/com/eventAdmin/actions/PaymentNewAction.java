			...
			try 
			  {
				...
				if(paymentNewForm.getProcess().equals("selectedSale"))
				  {
								...
								while ( iter.hasNext() )
								  {
									...
									if (beanPayments.getId_tipo_pago() != null)										
										paymentsRecord.setPay_type(beanPayments.getId_tipo_pago().getDescripcion());
									else
										paymentsRecord.setPay_type("");

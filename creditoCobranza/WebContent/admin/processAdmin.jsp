					...
					<s:else>
					   <div class="tab-content" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<table>
							...
							<tbody>
							<s:iterator value="#session.listUsers2Change" var="currentUser">
								...
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a href="processAdmin.action?id=<s:property value="#currentUser.id"/>&process=select2UserChange" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>

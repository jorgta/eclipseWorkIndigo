...
<body id="stylef<?php echo $default_font_family ?>" class="yjsgbody style_<?php echo $css_file.$browserClassName.$rtlClass ?> <?php echo $bg_file?>">
	...
	<div id="centerbottom" class="yjsgsitew">
		<div class="centerbottom_in">
			<?php yjsg_print_grid_area('yjsg6');/* grid 6 user16-user20*/ ?>
			<?php yjsg_print_grid_area('yjsg7');/* grid 7 user21-user25*/ ?>

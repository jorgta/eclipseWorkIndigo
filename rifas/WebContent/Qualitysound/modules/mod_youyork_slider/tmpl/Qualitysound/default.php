                ...
                <?php  for($m = 0;$m<count($slide2mods);$m++){
                                ...
                                foreach (array_keys($slide2_out) as $o) {
                                    ...
                                    if($slide2mods[$m] == $chek_module->position){
                                        $mt_module = 'You Cannot use module position '.$slide2mods[$m].'. It is taken by the slider ';
                                    }else{
                                        $mt_module 				= JModuleHelper::renderModule( $getmodule, $mt_attribs );
                                    }
                                    
                                ?>
                    <div class="yy_slideitems" style="width:<?php echo $items_width ?>px;height:<?php echo $slider_height ?>;">
                       <div class="yy_slideitems_in" style="height:<?php echo $slider_height ?>;">
                                <?php if ($showtitle == 1 ):?>

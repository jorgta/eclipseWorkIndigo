			...
			try
			  {
				...
				*/
				...
				/*ESTA ES UNA FUNCION QUE ENCONTRE QUE VALIDA LA FECHA.
				*/
				String fdt = "yyyy/MM/dd HH:mm"; //formato que utiliza
				SimpleDateFormat sdf = new SimpleDateFormat( fdt );
	                              sdf.setLenient( false );
	                              Date date = sdf.parse( str );
			...
			try
			  {
                ...
                int f = str.indexOf("/");
				int s = str.indexOf("/", f+1);
				int space = str.indexOf(" ", s+1);
				int firstTwoPoints = str.indexOf(":", space+1);
				

				String y = str.substring(0, f);
				String m = str.substring(f+1, s);
				String d = str.substring(s+1, space);
				String h = str.substring(space+1, firstTwoPoints);
				String mm = str.substring(firstTwoPoints+1, str.length());
				String ss = "00";
				

				String value = y+"-"+m+"-"+d+" "+h+":"+mm+":"+ss;

					...
					<ul>  
						...
						<s:iterator value="#session.processList" var="processUsers">
							...
							<s:if test="#processType.id == id_process.id_type_process.id">
							 ...
							 <a href="/bituosMonitorApp/pre.jsp?process=<s:property value="id_process.action"/>&action=<s:property value="id_process.url"/>" target="<s:property value="id_process.target"/>"><s:property value="id_process.description"/></a>

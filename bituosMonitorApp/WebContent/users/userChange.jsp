					   ...
					   <s:if test="#session.attention != null"> 
						...
						<form action="userChange" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label></label>
									<s:if test='#session.beanUser2Change.active == "Y"'>
									   
									   <input type="checkbox" checked="checked" disabled="disabled" />	El usuario estara activo 
								    </s:if>
								    <s:else>
								       <input type="checkbox" disabled="disabled" />El usuario estara activo 
								    </s:else>

    ...
    <s:if test="#session.processList != null"> 
			...
			<body class="bodyMain"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
				...
				<div id="main-content"> <!-- Main Content Section with everything -->
					...
					<!-- Page Head -->
					<h2></h2>
					<p id="page-intro"><s:text name="label.device.delete" /></p>
							...
							<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
							   ...
							   <s:if test="#session.attention != null"> 
								...
								<table>
									...
									<tbody>
									<s:iterator value="#session.listDeviceDelete" var="currentDevice">
										...
										<tr>
											...
											<td><s:property value="#currentDevice.creation_date"/></td>
															
											<td>
												<!-- Icons -->
												 <a href="deviceDelete?id=<s:property value="#currentDevice.id"/>&process=deviceDelete" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a> 
											</td>
										</tr>
									</s:iterator>
	 ...
	 <%
	 out.write("Llamada ilegal del modulo Baja de Usuario");
	 %>
	</s:else>

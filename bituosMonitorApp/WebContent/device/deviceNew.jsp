...
<s:if test="#session.module == 'pre'"> 
	...
	<body class="bodyMain"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<p id="page-intro"><s:text name="label.device.new" /></p>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<li><a href="#tab1" class="default-tab" >Nuevo Dispositivo</a></li>
						<li><a href="#tab2" >Dispositivos Registrados</a></li> <!-- href must be unique and match the id of target div -->
				...
				<div class="content-box-content">
					...
					<!--	<form action="New" method="post">
							...
							<fieldset> 
								...
								<p>
									...
									<label ><s:text name="label.device.name" /></label>
									<s:if test="fieldErrors['name'] != null">
										<s:textfield id="device" name="name" cssClass="text-input small-input" />
									...
									<s:else>
									  <s:textfield id="device" name="name" cssClass="text-input small-input" />
										...
										<br /><small>Nombre corto que usara para identificar la CPU</small>
								</p>
								
								<p>
									<label ><s:text name="label.device.cpuID" /></label>
									   <s:textfield id="device" name="cpuid" cssClass="text-input small-input" />
								</p>
								
							
								<p>
									<label ><s:text name="label.device.mbID" /></label>
									   <s:textfield id="device" name="mbid" cssClass="text-input small-input" />
								</p>
								...
								<p>
									...
									<s:checkbox id="useractive" name="active" value=""/>El usuario estara activo 
					...
					<div class="tab-content" id="tab2"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<table>
							...
							<tbody>
							<s:iterator value="#session.newDeviceBeanList" var="currentDevice">
	...
	<s:else>
	 <%
	   out.write("Llamada ilegal del modulo Nuevo Usuario");
	 %>
	</s:else>

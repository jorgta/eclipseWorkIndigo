  ...
  <s:if test="#session.module == 'pre'"> 
	...
	<body class="bodyMain"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2></h2>
			<p id="page-intro">Activacion de compañia</p>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<li><a href="#tab1" class="default-tab" >Compañias Registrados</a></li> <!-- href must be unique and match the id of target div -->
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
					   ...
					   <s:if test="#session.attention != null"> 
						...
						<table>
							...
							<tfoot>
								<tr>
									<td colspan="6">
										...
										<s:form action="companyActivate">
										
										    <input type="hidden" name="process" value="companyActivate" />
							...
							<tbody>
							<s:iterator value="#session.listCompanyActivate" var="currentCompany">
							
								<tr>
		
								  <td>
								  <s:if test="#session.listCompany2Activate != null">
								  
								  <s:set var="isIn" value="false" /> 
									  <s:iterator value="#session.listCompany2Activate" var="company2Activate">
										    <s:if test="#currentCompany.id==#company2Activate.id">
								  ...
								  <s:if test="#isIn == true">
								   <input name="checkbox<s:property value="#currentCompany.id"/>" type="checkbox" checked="checked"   onchange="change(<s:property value="#currentCompany.id"/>,'companyRemove2Activate');"/>
								  </s:if>
								  <s:else>
								      <input name="checkbox<s:property value="#currentCompany.id"/>" type="checkbox" onchange="change(<s:property value="#currentCompany.id"/>,'companyAdd2Activate');" />
								  </s:else>
								  </td>
	...
	<s:else>
	 <%
	 out.write("Llamada ilegal del modulo Activacion de Empresas");
	 %>
	</s:else>
...
{	
	...
	url= "companyActivate.action?id="+userid+"&process="+p;

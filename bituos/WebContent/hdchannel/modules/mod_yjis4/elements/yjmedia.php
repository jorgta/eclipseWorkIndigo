 ...
 * @since       11.1
 */
class JFormFieldYjmedia extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput(){
		 if(intval(JVERSION) < 3 ){			
					...
					$html[] = '		<a class="modal" id="opener_'.$this->fieldname.'" title="' . JText::_('JLIB_FORM_BUTTON_SELECT') . '"' . ' href="'
					...
					$html[] = '<div class="button2-left">';
					$html[] = '	<div class="blank">';
					$html[] = '		<a id="clear_'.$this->fieldname.'" title="' . JText::_('JLIB_FORM_BUTTON_CLEAR') . '"' . ' href="#" onclick="';
					...
					if ($this->element['disabled'] != true)
					{
						...
						$html[] = '<a class="modal btn"  id="opener_'.$this->fieldname.'" title="' . JText::_('JLIB_FORM_BUTTON_SELECT') . '"' . ' href="'
							. ($this->element['readonly'] ? ''
							: ($link ? $link
								: 'index.php?option=com_media&amp;view=images&amp;tmpl=component&amp;asset=' . $asset . '&amp;author='
								. $this->form->getValue($authorField)) . '&amp;fieldid=' . $this->id . '&amp;folder=' . $folder) . '"'
							. ' rel="{handler: \'iframe\', size: {x: 800, y: 500}}">';
						$html[] = JText::_('JLIB_FORM_BUTTON_SELECT') . '</a><a class="btn hasTooltip"  id="clear_'.$this->fieldname.'" title="' . JText::_('JLIB_FORM_BUTTON_CLEAR') . '"' . ' href="#" onclick="';
						$html[] = 'jInsertFieldValue(\'\', \'' . $this->id . '\');';
						$html[] = 'return false;';
						$html[] = '">';

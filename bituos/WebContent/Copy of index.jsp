...
<head>
  ...
  <title>Bituos Tools</title>
  <link href="hdchannel/index.html?format=feed&amp;type=rss" rel="alternate" type="application/rss+xml" title="RSS 2.0" />
  <link href="hdchannel/index.html?format=feed&amp;type=atom" rel="alternate" type="application/atom+xml" title="Atom 1.0" />
  <link href="hdchannel/templates/hdchannel/favicon.ico" rel="shortcut icon" type="image/vnd.microsoft.icon" />
  <link rel="stylesheet" href="hdchannel/components/com_k2/css/k2.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/modules/mod_yj_twitter/css/stylesheet.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/modules/mod_youyork_slider/css/stylesheet.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/modules/mod_yjme/css/stylesheet.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/modules/mod_yj_multitab/css/mod_yj_multitab.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/modules/mod_yjis4/css/mod_yjis4.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/modules/mod_yjis4/css/mediaboxAdv-Dark.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/modules/mod_yj_pop_login/css/stylesheet.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/modules/mod_yj_live_search/css/stylesheet.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/plugins/system/yjsg/assets/css/font-awesome.min.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/templates/hdchannel/css_compiled/bootstrap-red.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/plugins/system/yjsg/legacy/css/template.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/templates/hdchannel/css/menus.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/templates/hdchannel/css/layout.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/templates/hdchannel/css/red.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/plugins/system/yjsg/legacy/css/yjresponsive.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/templates/hdchannel/css/custom_responsive.css" type="text/css" />
  <link rel="stylesheet" href="hdchannel/templates/hdchannel/css/fontfacekits/Play/stylesheet.css" type="text/css" />
  <style type="text/css">
body{font-size:14px;}#logo{width:25%;height:110px;}#logo a{height:110px;}.yjsgsitew{width:1200px;}.yjsgheadergw{width:75%;}#midblock{width:66%;}#rightblock{width:34%;}#insetsholder_2t,#insetsholder_2b{width:34%;}
...
.hdcis .navContainer_inside:after{margin:0 0 0 -3px!important;}
...
#user16.yjsgxhtml{width:55.00%;}
#user17.yjsgxhtml{width:45.00%;}
#user21.yjsgxhtml{width:18.75%;}
#user22.yjsgxhtml{width:25.00%;}
#user23.yjsgxhtml{width:28.75%;}
#user24.yjsgxhtml{width:27.50%;}
  </style>
  <script src="hdchannel/media/system/js/mootools-core.js" type="text/javascript"></script>
  <script src="hdchannel/media/system/js/core.js" type="text/javascript"></script>
  <script src="hdchannel/media/system/js/caption.js" type="text/javascript"></script>
  <script src="hdchannel/media/system/js/mootools-more.js" type="text/javascript"></script>
  <script src="hdchannel/plugins/system/yjsg/assets/src/libraries/jquery.min.js" type="text/javascript"></script>
  <script src="hdchannel/plugins/system/yjsg/assets/src/libraries/jquery-noconflict.js" type="text/javascript"></script>
  <script src="hdchannel/plugins/system/yjsg/assets/src/yjsg.jquicustom.min.js" type="text/javascript"></script>
  <script src="hdchannel/plugins/system/yjsg/assets/bootstrap3/js/bootstrap.min.js" type="text/javascript"></script>
  <script src="hdchannel/plugins/system/yjsg/legacy/src/yjresponsive.js" type="text/javascript"></script>
  <script src="hdchannel/plugins/system/yjsg/legacy/src/yjsg.smoothdrop.js" type="text/javascript"></script>
  <script src="hdchannel/plugins/system/yjsg/assets/src/yjsg.site.plugins.js" type="text/javascript"></script>
  <script src="hdchannel/plugins/system/yjsg/assets/src/yjsg.site.js" type="text/javascript"></script>
  <script src="hdchannel/plugins/system/yjsg/assets/src/magnific/yjsg.magnific.popup.min.js" type="text/javascript"></script>
  <script src="hdchannel/modules/mod_youyork_slider/src/youyork_slider12.js" type="text/javascript"></script>
  <script src="hdchannel/modules/mod_yj_multitab/src/mod_yj_multitabfade12.js" type="text/javascript"></script>
  <script src="hdchannel/modules/mod_yjis4/src/mod_yjis4.min.js" type="text/javascript"></script>
  <script src="hdchannel/modules/mod_yjis4/src/yjmmbox.js" type="text/javascript"></script>
  <script src="hdchannel/modules/mod_yj_pop_login/src/yj_login_pop.js" type="text/javascript"></script>
  <script src="hdchannel/modules/mod_yj_live_search/script/YJLiveSearch.js" type="text/javascript"></script>
  <script src="hdchannel/components/com_k2/js/k2.js?v2.6.8&amp;sitepath=/hdchannel/" type="text/javascript"></script>
  <script src="hdchannel/templates/hdchannel/src/styles.js" type="text/javascript"></script>
...
window.addEvent('load', function() {
		  ...
		  window.addEvent('load', function(){
			  new YouYorkModuleSlider({
				  ...
				  navigation: {
					  'forward':'linkForward', 
					  'back':'linkBackward',
					  'screenNavsContainer':'yy_bottom-nav_bottom',
		  ...
		  window.addEvent('load', function(){
			  new YouYorkModuleSlider({
				  ...
				  navigation: {
					  'forward':'linkForward', 
					  'back':'linkBackward',
					  'screenNavsContainer':'yy_bottom-nav_right',
					  'screenNavsElem':'a.yy_nav'
				  }
			  });
		  });
	...
	window.addEvent('load', function(){
		  ...
		  window.addEvent('load', function(){
			  new YouYorkModuleSlider({
				  container : 'yy_container_intheaters', 
				  items :'.yy_slideitems',
				  itemWidth : 770,
				  visibleItems: 1,
				  effectDuration : 300,
		  ...
		  window.addEvent('load', function(){
			  new YouYorkModuleSlider({
				  container : 'yy_container_comingsoon', 
				  items :'.yy_slideitems',
				  itemWidth : 770,
				  visibleItems: 1,
				  effectDuration : 300,
		  ...
		  window.addEvent('load', function(){
			  new YouYorkModuleSlider({
				  container : 'yy_container_bestof2012', 
				  items :'.yy_slideitems',
				  itemWidth : 770,
				  visibleItems: 1,
				  effectDuration : 300,
				  ...
				  var modpath ='hdchannel/';
				  window.addEvent('domready', function(){
					  new YJSlide({
						  outerContainer : 'YJSlide_outer97',
						  innerContainer : 'YJSlide_inner97',
						  ...
						  navigationThumb: {
							  'forward':'thumbContainer_right97', 
							  'back':'thumbContainer_left97',
							  tnavHolder: 'thumbContainer97',
							  container: 'thumbContainer_belt97',
							  elements:'.thumbContainer_thumbLink97',
							  outer: 'thumbContainer_outer97',
							  visibleItems:3,
							  showThumbs:0,
							  thumbsOpacity:0.5,
							  showThumbArrows:1,
						  ...
						  navTooltips: 0,
						  autoslide: 0,
						  navInfo: 'YJS_nav_info97',
						  navLinks: '.YJS_navLink97',
						  navHolder: 'navContainer97',
						  slideWidth: '1170',
						  slideHeight:'430'
					  });
			  ...
			  window.addEvent('domready', function(){
					  ...
					  resultFeed:'hdchannel/modules/mod_yj_live_search/customfeeds/feed.php', 
...
<body id="stylef6" class="yjsgbody style_red yjsgbr-msie100">
	 
     	<div id="smallmenu_holder" style="font-size:14px;width:1200px;">
			<div id="smallmenu">
				<ul class="menu defaultmenu">
<li class="item-249 lifirst "><a class="afirst" href="hdchannel/index.html/in-theaters" >In Theaters</a></li><li class="item-250"><a href="hdchannel/index.html/coming-soon" >Coming Soon</a></li><li class="item-251 lilast"><a class="alast" href="hdchannel/index.html/best-of-2012" >Best of 2012</a></li></ul>
			</div>
		</div>
...
<div id="header">
    ...
    <!-- end logo -->
   <div id="yjsgheadergrid" class="yjsg_grid yjsgheadergw"><div id="header1" class="yjsgxhtml only_mod yjsgsfx-hdclm"><div class="yjsquare  hdclm modid95"><div class="yjsquare_in"><!-- http://www.Youjoomla.com YJ Pop Login for Joomla 1.7 and up starts here --> <script type="text/javascript">
window.addEvent('domready', function() {
		$("login_pop").setStyles({
...
<div id="login_pop" style="display:none;">
		<form action="hdchannel/index.html" method="post" name="login" id="form-login" >
		<label for="yjpop_username">Usuario</label>
		...
		<input type="hidden" name="534751a8c4ec5b376ef1a99548dcf093" value="1" />	</form>
	<a href="javascript:;" onclick="this.blur();showThem('login_pop');return true;" id="closeLogin">Cerrar</a> 
    
	<script type="text/javascript" src="hdchannel/media/system/js/validate.js"></script>
	<form action="hdchannel/index.html/component/users/?task=registration.register" method="post" id="josForm" name="josForm" class="form-validate">
		<div class="popyjreg">
            <div class="leftpart">
		...
		<p class="information_td">Campos marcados con (*) son requeridos.</p>
		<button class="button validate" type="submit">Registrar</button>
		<input type="hidden" name="option" value="com_users" />
...
</div></div><div class="yjsquare hdcls modid96"><div class="yjsquare_in"><!-- http://www.Youjoomla.com  Yj Live Live Search 2.0 for Joomla 2.5 starts here -->
 <div class="yjlivecont defaultfeed">
       <form method="get" action="hdchannel/index.html">
			<input type="hidden" name="searchword" id="defaultfeedLiveSearch" style="width:260px;" value="Search" onfocus="this.value='';" onblur="if(this.value==''){this.value='Search'};"  class="yj_inputbox"/>
...
<!-- http://www.Youjoomla.com  Yj Live Live Search 2.0  for Joomla 2.5 ends here --></div></div></div></div></div>
  <!-- end header -->
	...
	<li id="current" class=" active item101 level0 first"><span class="mymarg"><a class="yjanchor  first activepath " href="hdchannel/">
	<span class="yjm_has_desc">
	<span class="yjm_title">Inicio</span><span class="yjm_desc">Bituos Tools</span></span></a></span></li>
	       <li class="haschild item112 level0">
	       <span class="child">	<a class="yjanchor " href="#">
	       <span class="yjm_has_desc"><span class="yjm_title">Servicios</span>
	       		<span class="yjm_desc">Servicios de Soporte</span>
	       </span></a>
	       </span>
	       <ul class="subul_main level1"><li class="bl"></li><li class="tl"></li><li class="tr"></li><li class="haschild item138 level1 first"><span class="child subparent"><a class="yjanchor  first grouptitle" href="hdchannel/index.html/features/menu-types">
	       <span class="yjm_has_desc"><span class="yjm_title">Menu Types</span>
	       <span class="yjm_desc">Custom modules</span></span></a></span><ul class="subul_main level2"><li class="bl"></li><li class="tl"></li><li class="tr"></li><li class="item139 level2 first"><span class="mymarg"><a class="yjanchor  first" href="hdchannel/?change_menu=1"><span class="yjm_has_none">
		       <span class="yjm_title">YJ Mega CSS Dropdown</span></span></a></span></li><li class="item140 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/?change_menu=2"><span class="yjm_has_none">
		       <span class="yjm_title">YJ Mega Smooth Dropdown</span></span></a></span></li><li class="item141 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/?change_menu=3"><span class="yjm_has_none">
		       <span class="yjm_title">YJ Mega CSS Dropline</span></span></a></span></li><li class="item142 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/?change_menu=4"><span class="yjm_has_none">
		       <span class="yjm_title">YJ Mega Smooth Dropline</span></span></a></span></li><li class="item143 level2 lilast"><span class="mymarg"><a class="yjanchor last" href="hdchannel/index.html/features/menu-types?change_menu=5"><span class="yjm_has_none">
		       <span class="yjm_title">Joomla Split Menu</span></span></a></span></li><li class="right"></li><li class="br"></li></ul></li><li class="item144 level1"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/features/typography"><span class="yjm_has_desc">
	       <span class="yjm_title">Typography</span><span class="yjm_desc">Style your text</span></span></a></span></li><li class="item149 level1"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/features/module-positions"><span class="yjm_has_desc">
	       <span class="yjm_title">Module Positions</span><span class="yjm_desc">Over 50 positions!</span></span></a></span></li><li class="item236 level1 lilast"><span class="mymarg"><a class="yjanchor last" href="hdchannel/index.html/features/module-styles"><span class="yjm_has_desc">
	       <span class="yjm_title">Module Styles</span><span class="yjm_desc">Custom modules</span></span></a></span></li><li class="right"></li><li class="br"></li></ul></li><li class="haschild item145 level0"><span class="child"><a class="yjanchor " href="#"><span class="yjm_has_desc"><span class="yjm_title">Empresa</span><span class="yjm_desc">Socios Comerciales</span></span></a></span><ul class="subul_main level1"><li class="bl"></li><li class="tl"></li><li class="tr"></li><li class="item146 level1 first"><span class="mymarg"><a class="yjanchor  first" href="hdchannel/?change_css=red"><span class="yjm_has_none"><span class="yjm_title">Red</span></span></a></span></li><li class="item147 level1"><span class="mymarg"><a class="yjanchor " href="hdchannel/?change_css=blue"><span class="yjm_has_none"><span class="yjm_title">Blue</span></span></a></span></li><li class="item148 level1"><span class="mymarg"><a class="yjanchor " href="hdchannel/?change_css=green"><span class="yjm_has_none"><span class="yjm_title">Green</span></span></a></span></li><li class="item286 level1 lilast"><span class="mymarg"><a class="yjanchor last" href="hdchannel/?change_css=orange"><span class="yjm_has_none"><span class="yjm_title">Orange</span></span></a></span></li><li class="right"></li><li class="br"></li></ul></li><li class="haschild item234 level0"><span class="child"><a class="yjanchor " href="#"><span class="yjm_has_desc">
	       <span class="yjm_title">Tecnologia</span><span class="yjm_desc">Tecnologías de la información </span></span></a></span><ul class="subul_main level1"><li class="bl"></li><li class="tl"></li><li class="tr"></li><li class="haschild item223 level1 first"><span class="child subparent"><a class="yjanchor  first grouptitle" href="#"><span class="yjm_has_none"><span class="yjm_title">K2</span></span></a></span><ul class="subul_main level2"><li class="bl"></li><li class="tl"></li><li class="tr"></li><li class="haschild item224 level2 first"><span class="child"><a class="yjanchor  first" href="hdchannel/index.html/extras/k2/k2-channel"><span class="yjm_has_none"><span class="yjm_title">K2 Channel</span></span></a></span><ul class="subul_main level3"><li class="bl"></li><li class="tl"></li><li class="tr"></li><li class="item225 level3 first"><span class="mymarg"><a class="yjanchor  first" href="hdchannel/index.html/extras/k2/k2-channel/in-theaters"><span class="yjm_has_none"><span class="yjm_title">In Theaters</span></span></a></span></li><li class="item226 level3"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/extras/k2/k2-channel/coming-soon"><span class="yjm_has_none"><span class="yjm_title">Coming Soon</span></span></a></span></li><li class="item227 level3 lilast"><span class="mymarg"><a class="yjanchor last" href="hdchannel/index.html/extras/k2/k2-channel/best-of-2012"><span class="yjm_has_none"><span class="yjm_title">Best of 2012</span></span></a></span></li><li class="right"></li><li class="br"></li></ul></li><li class="item229 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/extras/k2/k2-item"><span class="yjm_has_none"><span class="yjm_title">K2 Item</span></span></a></span></li><li class="item230 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/extras/k2/k2-tag"><span class="yjm_has_none"><span class="yjm_title">K2 Tag</span></span></a></span></li><li class="item231 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/extras/k2/k2-user"><span class="yjm_has_none"><span class="yjm_title">K2 User</span></span></a></span></li><li class="item232 level2 lilast"><span class="mymarg"><a class="yjanchor last" href="hdchannel/index.html/extras/k2/k2-latest-items"><span class="yjm_has_none"><span class="yjm_title">K2 Latest Items</span></span></a></span></li><li class="right"></li><li class="br"></li></ul></li><li class="item279 level1"><a class="yjanchor " href="http://extensions.youjoomla.info/yj-pop-login.html" target="_blank" ><span class="yjm_has_none"><span class="yjm_title"> YJ Pop Login</span></span></a></li><li class="item283 level1"><a class="yjanchor " href="http://extensions.youjoomla.info/yj-multitabs.html" target="_blank" ><span class="yjm_has_none"><span class="yjm_title"> YJ Multitabs</span></span></a></li><li class="item252 level1"><a class="yjanchor " href="http://extensions.youjoomla.info/yj-live-search.html" target="_blank" ><span class="yjm_has_none"><span class="yjm_title">YJ Live Search</span></span></a></li><li class="item281 level1"><a class="yjanchor " href="http://extensions.youjoomla.info/yj-image-slider.html" target="_blank" ><span class="yjm_has_none"><span class="yjm_title">YJ Image Slider</span></span></a></li><li class="item285 level1"><a class="yjanchor " href="http://extensions.youjoomla.info/yj-latest-tweets.html" target="_blank" ><span class="yjm_has_none"><span class="yjm_title"> YJ Latest Tweets</span></span></a></li><li class="item282 level1"><a class="yjanchor " href="http://extensions.youjoomla.info/yj-module-engine.html" target="_blank" ><span class="yjm_has_none"><span class="yjm_title">YJ Module Engine</span></span></a></li><li class="item284 level1 lilast"><a class="yjanchor last" href="http://extensions.youjoomla.info/youyork-module-slider.html" target="_blank" ><span class="yjm_has_none"><span class="yjm_title">Youyork Module Slider</span></span></a></li><li class="right"></li><li class="br"></li></ul></li><li class="haschild item123 level0"><span class="child"><a class="yjanchor " href="#"><span class="yjm_has_desc"><span class="yjm_title">Enlaces</span><span class="yjm_desc">JDefaults</span></span></a></span><ul class="subul_main level1"><li class="bl"></li><li class="tl"></li><li class="tr"></li><li class="haschild item106 level1 first"><span class="child subparent"><a class="yjanchor  first grouptitle" href="#"><span class="yjm_has_none"><span class="yjm_title">User Pages</span></span></a></span><ul class="subul_main level2"><li class="bl"></li><li class="tl"></li><li class="tr"></li><li class="item107 level2 first"><span class="mymarg"><a class="yjanchor  first" href="hdchannel/index.html/jstuff/user-pages/login-form"><span class="yjm_has_desc"><span class="yjm_title">Login Form</span><span class="yjm_desc">Login Form demo</span></span></a></span></li><li class="item108 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/jstuff/user-pages/user-profile"><span class="yjm_has_desc"><span class="yjm_title">User Profile </span><span class="yjm_desc">User Profile Demo</span></span></a></span></li><li class="item109 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/jstuff/user-pages/user-regisrtation"><span class="yjm_has_desc"><span class="yjm_title">User Regisrtation</span><span class="yjm_desc">User Regisrtation Demo</span></span></a></span></li><li class="item110 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/jstuff/user-pages/username-reminder"><span class="yjm_has_desc"><span class="yjm_title">Username Reminder</span><span class="yjm_desc">Username Reminder Demo</span></span></a></span></li><li class="item111 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/jstuff/user-pages/password-reset"><span class="yjm_has_desc"><span class="yjm_title">Password reset</span><span class="yjm_desc">Password reset demo</span></span></a></span></li><li class="item113 level2 lilast"><span class="mymarg"><a class="yjanchor last" href="hdchannel/index.html?Itemid=8888"><span class="yjm_has_desc"><span class="yjm_title">404 page</span><span class="yjm_desc">404 page demo</span></span></a></span></li><li class="right"></li><li class="br"></li></ul></li><li class="haschild item129 level1"><span class="child subparent"><a class="yjanchor  grouptitle" href="hdchannel/index.html/jstuff/content-views"><span class="yjm_has_none"><span class="yjm_title">Content Views</span></span></a></span><ul class="subul_main level2"><li class="bl"></li><li class="tl"></li><li class="tr"></li><li class="item134 level2 first"><span class="mymarg"><a class="yjanchor  first" href="hdchannel/index.html/jstuff/content-views/category-blog-view"><span class="yjm_has_none"><span class="yjm_title">Category Blog View</span></span></a></span></li><li class="item135 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/jstuff/content-views/category-list-view"><span class="yjm_has_none"><span class="yjm_title">Category List View</span></span></a></span></li><li class="item136 level2"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/jstuff/content-views/categories-view"><span class="yjm_has_none"><span class="yjm_title">Categories View</span></span></a></span></li><li class="item137 level2 lilast"><span class="mymarg"><a class="yjanchor last" href="hdchannel/index.html/jstuff/content-views/archived-view"><span class="yjm_has_none"><span class="yjm_title">Archived View</span></span></a></span></li><li class="right"></li><li class="br"></li></ul></li><li class="item131 level1"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/jstuff/web-links"><span class="yjm_has_none"><span class="yjm_title">Web links</span></span></a></span></li><li class="item132 level1"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/jstuff/contacts"><span class="yjm_has_none"><span class="yjm_title">Contacts</span></span></a></span></li><li class="item133 level1"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/jstuff/news-feeds"><span class="yjm_has_none"><span class="yjm_title">News feeds</span></span></a></span></li><li class="item237 level1"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/jstuff/joomla-search"><span class="yjm_has_none"><span class="yjm_title">Joomla Search</span></span></a></span></li><li class="item125 level1 lilast"><a class="yjanchor last" href="http://www.youjoomla.com/joomla-installation-tutorials.html" target="_blank" ><span class="yjm_has_none"><span class="yjm_title">Joomla Tutorials</span></span></a></li><li class="right"></li><li class="br"></li></ul></li><li class="item104 level0"><span class="mymarg"><a class="yjanchor " href="hdchannel/index.html/grids-preview"><span class="yjm_has_desc"><span class="yjm_title">Contacto</span><span class="yjm_desc">Module Grids</span></span></a></span></li><li class="item287 level0"><a class="yjanchor " href="http://yjsimplegrid.com/shortcodes/" target="_blank" ><span class="yjm_has_desc"><span class="yjm_title">Shortcodes</span><span class="yjm_desc">Template Shortcodes</span></span></a></li></ul></div>
      </div>
  </div>
  <!-- end top menu -->
	</div>
	...
	<div id="centerbottom" class="yjsgsitew">
		<div class="centerbottom_in">
			<div id="yjsg1" class="yjsg_grid"><div id="top1" class="yjsgxhtml only_mod yjsgsfx-hdcis"><div class="yjsquare  hdcis modid97"><div class="yjsquare_in"><!-- http://www.Youjoomla.com  YJ Images Slider V4.0 Module for Joomla 1.6 and UP starts here -->
<div id="YJSlide_outer97" class="slide YJIS_outer  hdcis" style="width:1170px; height:430px;">
	<span id="slidesinfo_97" class="yjis_slidesinfo getw_1170">430</span>
	<div id="YJSlide_inner97" class="YJIS_inner" style="width:1170px;">
			<div class="YJSlide_slide starter active YJS_slidesholder" style="width:1170px; height:430px;">
		           			<a href="http://www.youtube.com/watch?v=GokKUqLcvD8" class="popbox YJS_mboxp">       
            <span class="YJS_reldata">lightbox[images/upload_slides/sliden1.jpg 1000 500]</span>
            	
			

			<img src="hdchannel/images/upload_slides/slider1.jpg"  class="yjisImg" alt="The Dark Knight Rises" />
		</a>			
				
					<div class="YJSlide_intro">
				<div class="YJSlide_intro_in">
					<h4>Redes Cableadas e Inalambricas</h4>
...
<a href="hdchannel/index.html/extras/k2/k2-channel/best-of-2012/item/27-the-dark-knight-rises" class="is_rm">More</a>
</div>                </div>
            </div>
				
		</div>
		
			<div class="YJSlide_slide starter inactive YJS_slidesholder" style="width:1170px; height:430px;">
		           			<a href="http://www.youtube.com/watch?v=T90Holdcrps" class="popbox YJS_mboxp">       
            <span class="YJS_reldata">lightbox[images/upload_slides/slide2.jpg 1000 500]</span>
            	
			

			<img src="hdchannel/images/upload_slides/cctv.jpg"  class="yjisImg" alt="" />
		</a>			
...
<div class="is_introholder">
<p>Una inversion para su familia, negocio y su vida...</p>
<a href="hdchannel/index.html/extras/k2/k2-channel/best-of-2012/item/26-the-hobbit-an-unexpected-journey" class="is_rm">More</a>
</div>                </div>
            </div>
			...
			<div class="YJSlide_slide starter inactive YJS_slidesholder" style="width:1170px; height:430px;">
		           			<a href="http://www.youtube.com/watch?v=QLR3HrV71yM" class="popbox YJS_mboxp">       
            <span class="YJS_reldata">lightbox[images/upload_slides/slide3.jpg 1000 500]</span>
            	
			

			<img src="hdchannel/images/upload_slides/Banner_telefonia2.jpg"  class="yjisImg" alt="" />
		</a>			
...
<a href="hdchannel/index.html/extras/k2/k2-channel/coming-soon/item/17-g-i-joe-retaliation" class="is_rm">More</a>
</div>                </div>
            </div>
			...
			<div class="YJSlide_slide starter inactive YJS_slidesholder" style="width:1170px; height:430px;">
		           			<a href="http://www.youtube.com/watch?v=ll39CAovGrg" class="popbox YJS_mboxp">       
            <span class="YJS_reldata">lightbox[images/upload_slides/slide4.jpg 1000 500]</span>
            	
			

			<img src="hdchannel/images/upload_slides/support_banner.jpg"  class="yjisImg" alt="" />
		</a>			
...
<a href="hdchannel/index.html/extras/k2/k2-channel/coming-soon/item/22-man-of-steel" class="is_rm">More</a>
</div>                </div>
            </div>
			...
			<div class="YJSlide_slide starter inactive YJS_slidesholder" style="width:1170px; height:430px;">
		           			<a href="http://www.youtube.com/watch?v=aV8H7kszXqo" class="popbox YJS_mboxp">       
            <span class="YJS_reldata">lightbox[images/upload_slides/slide5.jpg 1000 500]</span>
            	
			

			<img src="hdchannel/images/upload_slides/cropped-banner-arriba.jpg"  class="yjisImg" alt="" />
		</a>			
...
<a href="hdchannel/index.html/extras/k2/k2-channel/coming-soon/item/21-iron-man-3" class="is_rm">More</a>
</div>                </div>
            </div>
	    ...
	    <div id="navContainer97" class="navContainer" style="width:1170px;">
        <div class="navContainer_inside">
			                        <a href="#" class="YJS_navLink97 bnav active">
                1            </a>
                        <a href="#" class="YJS_navLink97 bnav">
                2            </a>
                        <a href="#" class="YJS_navLink97 bnav">
                3            </a>
                        <a href="#" class="YJS_navLink97 bnav">
...
<div id="holder2" class="holders">
	...
	<div id="midblock" class="sidebars sidebar-main">
		<div class="insidem">
			<div id="yjsgbodytop" class="yjsg_grid"><div id="bodytop1" class="yjsgxhtml only_mod yjsgsfx-custom1"><div class="yjsquare  custom1 modid98"><div class="h2_holder"><h2 class="module_title"><span class="title_split titlesplit0">Morbi</span> <span class="title_split titlesplit1">facilisis</span> <span class="title_split titlesplit2">nunc</span> <span class="title_split titlesplit3">Etiam</span></h2></div>
			<div class="yjsquare_in"><p>Nam vel diam fringilla diam dictum ultricies et eget elit. Aliquam erat volutpat. Donec purus tortor, eleifend in hendrerit sit amet, malesuada quis dui. Vivamus vel pulvinar diam. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas...</p>
<a class="template_readmore">Read more</a></div></div></div></div>						<div id="yjsgbodybottom" class="yjsg_grid"><div id="bodybottom1" class="yjsgxhtml only_mod yjsgsfx-hdcmt"><div class="yjsquare  hdcmt modid100"><div class="yjsquare_in"><!-- http://www.Youjoomla.com  Youjoomla Multitabs Modules for Joomla 1.6 starts here -->
<div id="tabs_holder">

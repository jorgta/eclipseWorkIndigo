...
public class ChatServlet
    ...
    public void event(CometEvent event)
        ...
        String nickNameRequest = (String) request.getParameter("nickname");
        String typeOS = request.getParameter("type");

        if (nickName == null) //nueva Session
          if ( typeOS == null ) //navegador
            {
          ...
          else if ( typeOS.equals("windows") ) //Rad Studio
           {
        	  nickName = nickNameRequest;
              request.getSession(true).setAttribute("nickname", nickName);
           }
                   ...
                   if( typeOS != null)  //Rad
                    {
	                    ...
	                    if (typeOS.equals("windows"))
	                    {
		                    writer.println("Sesion iniciada");
	                    }else
	                    {
	                    	writer.println(0);
	                    }

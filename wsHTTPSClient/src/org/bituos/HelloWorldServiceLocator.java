...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements org.bituos.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/wsHTTPS/services/HelloWorld";
    ...
    public org.bituos.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public org.bituos.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.bituos.HelloWorldSoapBindingStub _stub = new org.bituos.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.bituos.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                org.bituos.HelloWorldSoapBindingStub _stub = new org.bituos.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bituos.org", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bituos.org", "HelloWorld"));
        }

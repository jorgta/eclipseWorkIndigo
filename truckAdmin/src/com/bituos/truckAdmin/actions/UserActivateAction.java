...
import com.bituos.truckAdmin.forms.UserActivateForm;
				...
				try
				  {
					...
					BeanUser bean = (BeanUser) session.load( BeanUser.class, new Integer( userActivateForm.getId().toString() ) );
					...
					httpSession.setAttribute("done", new String("pre.do?process='userActivate'"));

				...
				try
				  {
					...
					if ( fileSize > MAX_SIZE)
					  ...
					  {					
					    ...
					    bean.setAdditional1( companyChangeForm.getAdditional1() );
					    bean.setAdditional2( companyChangeForm.getAdditional2() );
					    bean.setAdditional3( companyChangeForm.getAdditional3() );
					    bean.setAdditional4( companyChangeForm.getAdditional4() );
					    bean.setAdditional5( companyChangeForm.getAdditional5() );
					    bean.setAdditional6( companyChangeForm.getAdditional6() );
					    bean.setAdditional7( companyChangeForm.getAdditional7() );
					    bean.setAdditional8( companyChangeForm.getAdditional8() );
					    bean.setAdditional9( companyChangeForm.getAdditional9() );
					    bean.setAdditional10( companyChangeForm.getAdditional10() );

					    bean.setContractSigner( companyChangeForm.getContractSigner() );
					    bean.setPhones( companyChangeForm.getPhones() );
					    bean.setStreetContract( companyChangeForm.getStreetContract() );
					    bean.setColonyContract( companyChangeForm.getColonyContract() );
					    bean.setCityContract( companyChangeForm.getCityContract() );
					    bean.setStateContract( companyChangeForm.getStateContract() );

					    bean.setNameRptQuote( companyChangeForm.getNameRptQuote() );
					    bean.setNameRptSale( companyChangeForm.getNameRptSale() );
					    bean.setNameRptContract( companyChangeForm.getNameRptContract() );

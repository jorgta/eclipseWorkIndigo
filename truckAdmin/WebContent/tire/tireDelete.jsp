...
<html:html>
<head>
	<title>Eliminar Neumático </title>
...
<div class="x-blue_dg_caption"> <bean:message key="label.tire.list" /> </div><p></p>
			...
			<th class="x-blue_dg_th dg_left" style="background-color:#fcfaf6;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';" bgcolor="#fcfaf6"><a class="x-blue_dg_a_header" href="javascript:void('sort');"  title="Sort"><b><input title="Teclee aqui para buscar" type="text" id="search1" value=""  onkeyup="FAjax('data.jsp','POST','list=listTireDelete&field=design&value='+ this.value+ '&bean=BeanTire&module=tireDelete');"/>	</b> </a></th>
			<th class="x-blue_dg_th dg_center dg_nowrap" style="background-color:#fcfaf6;width:150px;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';" bgcolor="#fcfaf6"><a class="x-blue_dg_a_header" href="javascript:void('sort');"  title="Sort"><b><input title="Teclee aqui para buscar" type="text" id="search2" value=""  onkeyup="FAjax('data.jsp','POST','list=listTireDelete&field=deep&value='+ this.value+ '&bean=BeanTire&module=tireDelete');"/></b> </a></th>
			<th class="x-blue_dg_th dg_center dg_nowrap" style="background-color:#fcfaf6;width:150px;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';"><a class="x-blue_dg_a_header" href="javascript:void('sort');"  title="Sort"><b><input title="Teclee aqui para buscar" type="text" id="search3" value=""  onkeyup="FAjax('data.jsp','POST','list=listTireDelete&field=position&value='+ this.value+ '&bean=BeanTire&module=tireDelete');"/></b> </a></th>
			<th class="x-blue_dg_th dg_center dg_nowrap" style="background-color:#fcfaf6;width:150px;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';"><a class="x-blue_dg_a_header" href="javascript:void('sort');"  title="Sort"><b><input title="Teclee aqui para buscar" type="text" id="search4" value=""  onkeyup="FAjax('data.jsp','POST','list=listTireDelete&field=serial_number&value='+ this.value+ '&bean=BeanTire&module=tireDelete');"/></b> </a></th>
			<th class="x-blue_dg_th dg_center dg_nowrap" style="background-color:#fcfaf6;width:150px;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';"><a class="x-blue_dg_a_header" href="javascript:void('sort');"  title="Sort"><b><input title="Teclee aqui para buscar" type="text" id="search5" value=""  onkeyup="FAjax('data.jsp','POST','list=listTireDelete&field=id_type_tire_status.description&value='+ this.value+ '&bean=BeanTire&module=tireDelete');"/></b> </a></th>
			<th class="x-blue_dg_th dg_center dg_nowrap" style="background-color:#fcfaf6;width:150px;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';"><a class="x-blue_dg_a_header" href="javascript:void('sort');"  title="Sort"><b><input title="Teclee aqui para buscar" type="text" id="search6" value=""  onkeyup="FAjax('data.jsp','POST','list=listTireDelete&field=id_place.description&value='+ this.value+ '&bean=BeanTire&module=tireDelete');"/></b> </a></th>
			<th class="x-blue_dg_th dg_center dg_nowrap" style="background-color:#fcfaf6;width:150px;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';"><a class="x-blue_dg_a_header" href="javascript:void('sort');"  title="Sort"><b><input title="Teclee aqui para buscar" type="text" id="search7" value=""  onkeyup="FAjax('data.jsp','POST','list=listTireDelete&field=id_type_measure.description&value='+ this.value+ '&bean=BeanTire&module=tireDelete');"/></b> </a></th>
			<th class="x-blue_dg_th dg_center dg_nowrap" style="background-color:#fcfaf6;width:150px;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';"><a class="x-blue_dg_a_header" href="javascript:void('sort');"  title="Sort"><b><input title="Teclee aqui para buscar" type="text" id="search8" value=""  onkeyup="FAjax('data.jsp','POST','list=listTireDelete&field=id_truck.registration&value='+ this.value+ '&bean=BeanTire&module=tireDelete');"/></b> </a></th>
			...
			<% String cuStyleBackground="rgb(255, 255, 255)";
			   ...
			   int i=0;
			%>
			<logic:iterate id="id" indexId="indexId" name="listTireDelete" scope="session" >
			<%
			...
			%>
			  ...
			  <script type="text/javascript">
				//<![CDATA[
				var theForm = document.forms['tireDeleteForm'];

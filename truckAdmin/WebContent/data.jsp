...
<%
	...
	queryFilterActive1 =" WHERE u.active = 'Y'";
	
	queryFilterActive2 =" AND u.active = 'Y'";
	...
	if(searchValue == null || searchValue == "")
	{
		if(active == null || active == "")
		{
			...
			query =  " FROM " + bean + " u" + queryFilterActive1 ;
		
	}
	else
	{
	    query =  " FROM " + bean + " u" +
		         " WHERE " + queryFilter + queryFilterActive2;
	}
	...
	if(listObjects.isEmpty())
	{
		if (module.equals("truck"))
			...
			cols ="5";
		else if (module.equals("tireMovements"))
			cols ="8";
		else if (module.equals("truckSelectMovements"))
			cols ="4";
	...
	<%         String cuStyleBackground="rgb(255, 255, 255)";
			...
			%> 	
	           ...
	           <tr class="dg_tr" style="background: none repeat scroll 0% 0% <%=cuStyleBackground %>;" id="tirelist_row_<%=i%>" 
			    ...
			    <td class="x-blue_dg_td dg_center dg_nowrap" style=""><label class="x-blue_dg_label" id="updated_at_1">  <bean:write name="id" property="id_type_place.description" /></label></td>

					...
					<div class="content-box"><!-- Start Content Box -->
						...
						<div class="content-box-header">
							...
							<ul class="content-box-tabs">
								<li><a href="#tab1" class="default-tab">Lista de Usuarios</a></li> <!-- href must be unique and match the id of target div -->
								<li><a href="#tab2">Alta de Usuarios</a></li>
							</ul>
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>JORGE</td>
											<td>torres</td>
											<td>arcos de carrucel #931 tel: 4837363</td>
											<td></td>
											<td>
												<!-- Icons -->
												 <a href="#" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>

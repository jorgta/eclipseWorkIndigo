...
<%  
   ...
   // viewer.setDatabaseLogonInfos(arg0)
...
//	viewer.refresh();
	...
	//clientDoc.open(report,0);
  //  clientDoc.getDataDefinition().setParameterFields(parameterFields);
    ...
    try
    ...
    catch( Throwable  m)
      {
	    ...
	    response.sendRedirect("/struts2Hibernate/notOK.jsp");
      }
    finally
      {
	    viewer.dispose();

...
<li class="lang" id="current_language">Login: <span><A href="login.jsp">aqui</A></span></li>
...
<BR>
<BR>
Asegurese de seleccionar adecuadamente la Estacion de Servicio (ES) donde hizo su despacho, tanto en el siguiente enlace, como en la pagina siguiente:

<UL>
<li class="lang" id="current_language"> <span><A href="http://es7016.dyndns.org:7016/ControlGasFE">ES 7016</A></span></li>
<li class="lang" id="current_language"> <span><A href="http://es7481.dyndns.org:7481/ControlGasFE">ES 7481</A></span></li>
<li class="lang" id="current_language"> <span><A href="http://es8136.dyndns.org:8136/ControlGasFE">ES 8136</A></span></li>
<li class="lang" id="current_language"> <span><A href="http://es9012.dyndns.org:9012/ControlGasFE">ES 9012</A></span></li>
<li class="lang" id="current_language"> <span><A href="http://es11148.dyndns.org:8085/ControlGasFE">ES 11148</A></span></li>
<li class="lang" id="current_language"> <span><A href="http://es12401.dyndns.org:12401/ControlGasFE">ES 12401</A></span></li>
</UL>
<BR>
<BR>

Sino accede al enlace de la ES, favor de enviar un email con sus datos fiscales y los datos que aparecen en la imagen de mas abajo, a la siguiene direccion:  

<a href="mailto:facturacion.gasolinera@gjv.mx?Subject=Favor%20de%20enviar%20factura%20electronica"> facturacion.gasolinera@gjv.mx </a>

<BR>
<BR>
<BR>
<BR>
<img src="images/ticketControlGas.png">

...
<BODY>
	...
	<CENTER><H1><bean:message key="label.user.asign.supervisor" /></H1></CENTER>
	...
	<logic:present name="beanUser" scope="session">
		  ...
		  <logic:present name="processList" scope="session">
				...
				<TBODY>
					...
					<TR>
						<TD>
						   ...
						   <html:hidden property="forward" value="asignSupervisor"/>
					...
					<TR>
						<TD>						
							<html:select property="filter" multiple="multiple" size="10">						
			...
			<html:form action="/asignSupervisor">
			<TABLE border="0" ALIGN="CENTER">
				<TBODY>
					<TR>
						<TD class="column_field"><bean:message key="label.user.number" /></TD>
						<TD><html:text property="id_user"></html:text></TD>
			        		<TD> <FONT COLOR="RED"> <html:errors property="id_user"/></FONT> 
					</TR>
					<TR>
						<TD class="column_field"><bean:message key="label.supervisor.number" /></TD>
						<TD><html:text property="id_supervisor" size="60"></html:text></TD>
			        		<TD> <FONT COLOR="RED"> <html:errors property="id_supervisor"/></FONT> 
					</TR>
					<TR>

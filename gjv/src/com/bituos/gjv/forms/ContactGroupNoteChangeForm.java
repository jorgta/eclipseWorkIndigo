...
public class ContactGroupNoteChangeForm extends ActionForm {
		 ...
		 if ( idContact != null )
		  {
		    ...
		    if (idContact.length() == 0)
			    errors.add("idContact", new org.apache.struts.action.ActionError("error.field.required"));			  
		  }
	    else
		 ...
		 if ( note != null )
			{
			 note = note.trim();
			  if (note.length() == 0)
				  errors.add("note", new org.apache.struts.action.ActionError("error.field.required"));			  
			}
		  else
			errors.add("note", new org.apache.struts.action.ActionError("error.field.required")); 
		 ...
		 if ( fecha != null )
			{
			   fecha = fecha.trim();
			  if (fecha.length() == 0)
				  errors.add("fecha", new org.apache.struts.action.ActionError("error.field.required"));
			  else
				{		
					if(!Utils.IsDate(fecha))
						errors.add("fecha", new org.apache.struts.action.ActionError("error.field.invalid.date"));			
				}
			}
		  else
			errors.add("fecha", new org.apache.struts.action.ActionError("error.field.required")); 

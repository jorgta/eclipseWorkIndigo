...
<BODY>
	...
	<CENTER><H1> <bean:message key="label.client.delete" />  </H1></CENTER>
		  ...
		  <logic:present name="processList" scope="session">
			...
			<TABLE border="0" align="center">
				<TBODY>
					<TR align="center">
						<TD>
						   <bean:message key="label.client.number" />
						   <BR>
					...
					<TR align="center">
					    <TD>
           	  			    <html:submit property="a1"><bean:message key="label.register" /></html:submit>			           			    
						</TD>
					</TR>
					<TR align="center">
					    <TD>

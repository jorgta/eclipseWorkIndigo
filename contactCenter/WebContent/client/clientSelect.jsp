...
<BODY>
	...
	<CENTER><H1> <bean:message key="label.client.select" />  </H1></CENTER>
				...
				<TBODY>
					<TR align="center">
						<TD><bean:message key="label.client.number" /><BR>
							<html:text property="id" value=""></html:text><BR>
							<FONT COLOR="RED"> <html:errors property="id"/></FONT>
			        	</TD> 
					</TR>
					<TR align="center">
					    <TD>
					      <html:submit property="a"><bean:message key="label.select" /></html:submit>			           			    
					     </TD>

...
<HTML>
<HEAD>
<%@ taglib uri="/WEB-INF/crystal-tags-reportviewer.tld" prefix="Web_Reporting_Tag_Library" %>
<%@ page 
language="java"
...
<%@ page session="true" import="java.util.*, com.tecunsa.*, com.tecunsa.Beans.*, java.io.*, javax.servlet.http.HttpSession.*"%>

		  ...
		  <logic:present name="processList" scope="session">
				...
				<TBODY>
					...
					<TR>
						<TD>
						   ...
						   <html:hidden property="forward" value="asign"/>
					...
					<TR>
						<TD>						
							<html:select property="id" multiple="multiple" size="10">						
			...
			<TABLE border="0" ALIGN="CENTER">
				<TBODY>
					...
					<TR>
						<TD class="column_field"><bean:message key="label.user.number.supervisor" /></TD>

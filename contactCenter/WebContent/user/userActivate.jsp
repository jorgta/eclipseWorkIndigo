...
<BODY>
	...
	<CENTER><H1> <bean:message key="label.user.activate" />  </H1></CENTER>
		  ...
		  <logic:present name="processList" scope="session">
			...
			<TABLE border="0" ALIGN="CENTER">
				<TBODY>
					...
					<TR align="center">
					    <TD>
					    	<CENTER><P align="left"><html:submit><bean:message key="label.search" /></html:submit></P></CENTER>
						</TD>
					</TR>
...
<HR>
			...
			<TABLE border="0" align="center" >
				<TBODY>
					<TR align="center">
						<TD class="column_field"><bean:message key="label.user.number"/><BR>
						<html:text property="id"></html:text><BR>
			        	<FONT COLOR="RED"> <html:errors property="id"/></FONT></TD> 
					</TR>
					<TR align="center">
					    <TD>
					    	<html:submit onclick="submit();"><bean:message key="label.activate" /></html:submit>

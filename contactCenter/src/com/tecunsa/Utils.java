...
import java.util.*;
import java.text.*;
import com.tecunsa.Beans.BeanStates;
 ...
 */
	...
	/**
	 * @return Retorna fecha en formato string: yyyymmdd
	 */
		public static String DateToStrInvMySQL( Date d )
		  {
			/*
			String s = d.getYear() + "/" + d.getMonth() + "/" + d.getDate();
			...
			*/
			...
			String months = formatter.format( c.get( Calendar.MONTH) + 1 );  
			String days = formatter.format( c.get( Calendar.DATE) );  

...
public class FlowerEditForm extends ActionForm {
			...
			if( process != null )
			  {
				...
				else if( process.equals("createList"))
				  {
				...
				else if( process.equals("createMenu"))
				  {
					if( id_option==null  )
					  errors.add("id_option", new org.apache.struts.action.ActionError("error.must.select.value"));
					else
					...
					if( menuName==null  )
						  errors.add("menuName", new org.apache.struts.action.ActionError("error.must.select.value"));
					else
					  {
					...
					if( menuPrice==null  )
						  errors.add("menuPrice", new org.apache.struts.action.ActionError("error.must.select.value"));
					else
					  {
						...
						if (  menuPrice.length() == 0  )
						  ...
						  if( !Utils.isDouble(menuPrice) )
							errors.add("menuPrice", new org.apache.struts.action.ActionError("error.field.invalid.format"));
					  }
					
					if( menuDescription==null  )
						  errors.add("menuDescription", new org.apache.struts.action.ActionError("error.must.select.value"));
					else
					  {

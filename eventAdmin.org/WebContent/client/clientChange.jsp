...
<BODY>
	...
	<logic:present name="beanUser" scope="session">
		  ...
		  <logic:present name="processList" scope="session">
			...
			<TABLE border="0" ALIGN="CENTER">
				<TBODY>
					<TR>
						...
						<TD class="table_capture_field"><html:text property="name" readonly="true" disabled="true" size="60"></html:text>
			...
			<CENTER><P><html:submit> <bean:message key="label.change" /> </html:submit></P></CENTER>			

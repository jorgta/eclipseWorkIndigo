...
function() {
		...
		// returns a jQ object with a 'g' property - that's ingrid
		 mygrid1 = $("#table1").ingrid({ 
										url:'data.jsp?bean=BeanUser&list=listUserDelete&fields=fields&active=Y',
										height: 350,
										savedStateLoad: true,
...
function FAjax(url,metodo,valor)
{
  // 'data.jsp?bean=BeanUser&list=listUserDelete&fields=fields'
  //alert(trim(valor).length);
 // alert(document.getElementById('capa').style.visibility);
...
<BODY>
	...
	<H1> <bean:message key="label.user.delete" />  </H1>
			...
			<TABLE border="0" ALIGN="CENTER">
				<TBODY>
					...
					<TR>
					    ...
					    <!--<button class="button danger icon remove" type="submit"  ><bean:message key="label.delete" /></button> -->
						</TD>
					</TR>
					<TR>
...
<td>Buscar
 ...
 <td >
		...
		<input title="Teclee aqui para buscar" type="text" id="search" value=""  onkeyup="FAjax('data.jsp?bean=BeanUser&list=listUserDelete&fields=fields&searchValue='+this.value+'&searchParam=name&active=Y','GET',this.value);"/>
		



</td>
<td><a href="#" class="button danger" onclick="location='/eventAdmin/main.jsp';" ><bean:message key="label.finish" /></a></td>
</tr>
<tr>
<td colspan="3">	
	 <div id="capa"  style="overflow: scroll; height: 150px; width: 500px; position: absolute; z-index: 5000; background-color: silver; visibility: hidden; vertical-align: top;">

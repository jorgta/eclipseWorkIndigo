...
<BODY>
	...
	<H1> <bean:message key="label.company.activate" />  </H1>
	...
	<logic:present name="beanUser" scope="session">
		  ...
		  <logic:present name="processList" scope="session">
			...
			<html:form action="/companyActivate">
				...
				<TBODY>
					<TR>
						...
						<logic:iterate id="id" indexId="indexId" name="list" scope="session" >
						    <OPTION value= <%="'"%><bean:write name="id" property="id" /><%="'"%>  >  <bean:write name="id" property="full_name" /> </OPTION>
					    </logic:iterate>
					...
					<TR>
					    <TD align="center"><html:submit ><bean:message key="label.activate" /></html:submit>
						</TD>
					</TR>
					<TR>

			...
			if ( (Configuration)ses.getAttribute( "configuration" ) == null )
			  {
				...
				conf.addClass(BeanHotel.class);
				conf.addClass(BeanRoom.class);
				conf.addClass(BeanSpec.class);
				conf.addClass(BeanRoom_Specs.class);
				conf.addClass(BeanReservation.class);
				conf.addClass(BeanReservation_Person.class);
				conf.addClass(BeanType_Status_Room.class);
				conf.addClass(BeanType_Status_Reservation.class);
				conf.addClass(BeanReservation_Rooms.class);
				conf.addClass(BeanType_Reservation.class);
				conf.addClass(BeanTypeTransport.class);
				conf.addClass(BeanTransport.class);
				conf.addClass(BeanQuote.class);
				conf.addClass(BeanQuote_Person.class);
				conf.addClass(BeanQuote_Room.class);

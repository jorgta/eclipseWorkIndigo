...
<s:if test="#session.module == 'pre'"> 
	...
	<body class="bodyMain"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2></h2>
			<p id="page-intro">Baja de habitación</p>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<ul class="content-box-tabs">
					   <li><a href="#tab1" class="default-tab" >Baja de Habitaciones</a></li> <!-- href must be unique and match the id of target div -->
				   </ul>
				...
				<div class="content-box-content">
					  ...
					  <s:form action="roomDelete">
						 	 <input type="hidden" name="process" value="DeleteRooms" />
					   ...
					   <table>
							...
							<s:iterator value="#session.listRoomsHability" var="currentRoom">
							     <tr>
									...
									<td>
										<!-- Icons -->
										 <a href="roomDelete.action?id=<s:property value="#currentRoom.id"/>&process=deleteOneRoom" title="Eliminar habitación"><img src="resources/images/icons/cross.png" alt="Delete" /></a>
									</td>
								</tr>
						    </s:iterator>
	 ...
	 <%
	   out.write("Llamada ilegal del módulo Baja de Habitación");
	 %>
</s:if>

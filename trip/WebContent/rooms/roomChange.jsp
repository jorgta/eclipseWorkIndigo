...
<s:if test="#session.module == 'pre'"> 
	...
	<body class="bodyMain"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2></h2>
			<p id="page-intro"><label ><s:text name="label.room.change" /></p>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<s:if test='%{#session.beanRoom2Change == null}'>
					    <li><a href="#tab1" class="default-tab"><label ><s:text name="label.room.rooms" /></label></a></li>
						<li><a href="#tab2" ><label ><s:text name="label.room.changeRoom" /></label></a></li>
					</s:if>
				    <s:else>
					<s:if test='%{#session.beanRoom2Change != null}'>
					    <li><a href="#tab1" ><label ><s:text name="label.room.rooms" /></label></a></li>
						<li><a href="#tab2" class="default-tab"><label ><s:text name="label.room.changeRoom" /></label></a></li>
					</s:if>
				   </s:else>
				...
				<div class="content-box-content">
					...
					<table>
							...
							<thead>
								...
								<tr>
								    <th><label ><s:text name="label.room.hotelToOwner" /></th>
								    <th><label ><s:text name="label.room.rooms" /></th>	
							...
							<s:iterator value="#session.listRoomsHability" var="currentRoom">
							     <tr>
									...
									<td>
										<!-- Icons -->
										 <a href="roomChange.action?id=<s:property value="#currentRoom.id"/>&process=selectedRoom2Change" title="Cambiar Habitación"><img src="resources/images/icons/pencil.png" alt="Cambiar Habitación" /></a>
								   </td>
								</tr>
						    </s:iterator>
						    </tbody>
					...
					<s:if test="%{#session.beanRoom2Change != null}">						
					   ...
					   <s:if test="#session.attention != null"> 
						...
						<form action="roomChange" method="post" enctype="multipart/form-data">
							<input type="hidden" name="process" value="selectedRoom" />
							<fieldset class="column-left"> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								<p>
									...
									<s:else>
									<s:textfield id="hotel" name="hotel" cssClass="text-input medium-input" value="%{#session.beanRoom2Change.id_hotel.description}" readonly="true"/>
								...
								<p>
									...
									<s:else>
									<s:textfield id="description" name="description" cssClass="text-input medium-input" value="%{#session.beanRoom2Change.description}"/>
									</s:else>
								</p>
								<p>
									<label ><s:text name="label.room.date_begin" /></label>
									 <s:if test="#session.date_begin != null">
										...
										<s:else>
										<s:textfield id="datetimepicker1" name="date_begin" cssClass="text-input small-input datepicker" value="%{#session.date_begin}"/>
										</s:else>
									</s:if>
								 </p>
								 <p>
									<label ><s:text name="label.room.date_end" /></label>
									<s:if test="#session.date_end != null">
										...
										<s:else>
										<s:textfield id="datetimepicker2" name="date_end" cssClass="text-input small-input datepicker" value="%{#session.date_end}"/>
										</s:else>
									</s:if>
								 </p>
								 <label ><s:text name="label.room.specs" /></label>
								  <s:if test="#session.listSpecs != null && #session.listSpecsAdd != null">  
								  <s:iterator value="#session.listSpecs" var="currentSpec">
							  		<s:set var="isIn" value="false" /> 
									 <s:iterator value="#session.listSpecsAdd" var="currentSpecAdd">
								         <s:if test="#currentSpec.id==#currentSpecAdd.id_spec.id">
										    	<s:set var="isIn" value="true" />
										 </s:if>
									</s:iterator>
									<s:if test="#isIn == true">
											<input type="checkbox" name="specs" checked="checked"  value="<s:property value="#currentSpec.id"/>" id="<s:property value="#currentSpec.id"/>"/>
								 ...
								 <s:else>
								   <s:if test="#session.listSpecs != null">
								      <s:iterator value="#session.listSpecs" var="currentSpec">
								          <input type="checkbox" name="specs" value="<s:property value="#currentSpec.id"/>" id="<s:property value="#currentSpec.id"/>"/>
										 <s:label value=""><s:property value="#currentSpec.description"/></s:label>
								...
								<p>
									...
									<s:else>
										<s:textfield id="price1" name="price1" cssClass="text-input small-input" value="%{#session.beanRoom2Change.price1}"/>
									</s:else>
								</p>	
								<p>
									...
									<s:else>
										<s:textfield id="price2" name="price2" cssClass="text-input small-input" value="%{#session.beanRoom2Change.price2}"/>
									</s:else>
								</p>
								<p>
									...
									<s:else>
										<s:textfield id="price3" name="price3" cssClass="text-input small-input" value="%{#session.beanRoom2Change.price3}"/>
									</s:else>
								</p>
								<p>
									...
									<s:else>
										<s:textfield id="price4" name="price4" cssClass="text-input small-input" value="%{#session.beanRoom2Change.price4}"/>
									</s:else>
								</p>
								<p>
								...
								<p>
									...
									<s:else>
										<s:textfield id="priceBasic" name="priceBasic" cssClass="text-input small-input" value="%{#session.beanRoom2Change.priceBasic}"/>
									</s:else>
								</p>
								<p>
									...
									<s:else>
										<s:textfield id="priceChild" name="priceChild" cssClass="text-input small-input" value="%{#session.beanRoom2Change.priceChild}"/>
									</s:else>
								</p>
								<p>
									...
									<s:else>
										<s:textfield id="priceJr" name="priceJr" cssClass="text-input small-input" value="%{#session.beanRoom2Change.priceJr}"/>
									</s:else>
								</p>
								<p>
					...
					<s:else>
					    <label ><s:text name="label.room.selectRoom" /></label>
					</s:else>
	 ...
	 <%
	   out.write("Llamada ilegal del módulo Cambiar Habitación");
	 %>
</s:if>

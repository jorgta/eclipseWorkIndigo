		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<li><a href="#tab1" class="default-tab" >Nuevo Usuario</a></li>
						<li><a href="#tab2" >Usuarios Registrados</a></li> <!-- href must be unique and match the id of target div -->
				...
				<div class="content-box-content">
					   ...
					   <s:if test="#session.attention != null"> 
						...
						<form action="userNew" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
								  <!--<s:text name="label.user.name" />
								  <s:textfield key="label.user" name="username"/>-->
									<label ><s:text name="label.user.name" /></label>
								...
								<p>
									<label ><s:text name="label.password" /></label>
								...
								<p>
									...
									<label ><s:text name="label.address" /></label>								
								...
								<p>
									...
									<label ><s:text name="label.email" /></label>	
					...
					<div class="tab-content" id="tab2"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<table>
							...
							<tbody>
							<s:iterator value="#session.newUserBeanList" var="currentUser">
							
								<tr>
								
									<s:if test='#currentUser.active == "Y"'>

    ...
    <s:if test="#session.processList != null"> 
			...
			<body class="bodyMain"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
				...
				<div id="main-content"> <!-- Main Content Section with everything -->
					...
					<!-- Page Head -->
					<h2></h2>
					<p id="page-intro">Baja de usuarios</p>
							...
							<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
							   ...
							   <s:if test="#session.attention != null"> 
								...
								<table>
									...
									<tbody>
									<s:iterator value="#session.listUserDelete" var="currentUser">
									
										<tr>
										
											<s:if test="#currentUser.active ='N'">
											...
											<td>
												<!-- Icons -->
												 ...
												 <a href="userDelete.action?id=<s:property value="#currentUser.id"/>&process=userDelete" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a> 

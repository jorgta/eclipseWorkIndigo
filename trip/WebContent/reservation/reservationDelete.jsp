				...
				<div class="content-box-content">
					...
					<s:else>
					   <div class="tab-content" id="tab1">
						...
						<s:form action="reservationDelete">
				         <input type="hidden" name="process" value="cancelSomeRooms" />
						...
						<table id="tabla1">
						   ...
						   <tbody>
							<s:iterator value="#session.roomsReserved" var="currentRoom_Reservation">
								...
								<tr>
								    <td><input type="checkbox" name="rooms" value="<s:property value="#currentRoom_Reservation.id"/>" id="<s:property value="#currentRoom_Reservation.id"/>"/></td>

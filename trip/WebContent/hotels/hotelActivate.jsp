  ...
  <s:if test="#session.module == 'pre'"> 
	...
	<body class="bodyMain"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2></h2>
			<p id="page-intro">Activación de hoteles</p>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
					   ...
					   <s:if test="#session.attention != null"> 
						...
						<s:form action="hotelsActivate">
					         <input type="hidden" name="process" value="hotelsActivate" />
						<table>
							...
							<tbody>
						<s:iterator value="#session.listHotelActivate" var="currentHotel">
							...
							<tr>
								...
								<td><s:property value="#currentHotel.id_company.name"/></td>
							</tr>
						</s:iterator>
	 ...
	 <%
	   out.write("Llamada ilegal del modulo Activación de Hotel");
	 %>

...
<s:if test="#session.module == 'pre'"> 
	...
	<body class="bodyMain"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2></h2>
			<p id="page-intro"><label ><s:text name="label.hotel.new" /></label>
			</p>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<li><a href="#tab1" class="default-tab" ><label ><s:text name="label.hotel.newHotel" /></label></a></li>
						<li><a href="#tab2" ><label ><s:text name="label.hotel.hotels" /></label></a></li> <!-- href must be unique and match the id of target div -->
				...
				<div class="content-box-content">
					<div class="tab-content default-tab"  id="tab1">
					   ...
					   <s:if test="#session.attention != null"> 
						...
						<form action="newHotels" method="post" enctype="multipart/form-data">
					...
					<div class="tab-content" id="tab2"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<table>
							...
							<thead>
								...
								<tr>
								   <th><label ><s:text name="label.hotel.active" /></label></th>								  
								   <th><label ><s:text name="label.hotel.hotel" /></label></th>								   
								   <th><label ><s:text name="label.hotel.address" /></label></th>
                                </tr>
							...
							<tbody>
							<s:iterator value="#session.hotelsNewBeanList" var="currentHotel">
	 ...
	 <%
	   out.write("Llamada ilegal del módulo Nuevo Hotel");
	 %>
</s:if>
<script>

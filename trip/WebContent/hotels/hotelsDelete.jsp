    ...
    <s:if test="#session.processList != null"> 
			...
			<body class="bodyMain"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
				...
				<div id="main-content"> <!-- Main Content Section with everything -->
					...
					<!-- Page Head -->
					<h2></h2>
					<p id="page-intro">Baja de hoteles</p>
					...
					<div class="content-box"><!-- Start Content Box -->
						...
						<div class="content-box-header">
							...
							<li><a href="#tab1" class="default-tab" >Hoteles registrados</a></li> <!-- href must be unique and match the id of target div -->
						...
						<s:form action="hotelsDelete">
						 	<input type="hidden" name="process" value="DeleteHotels" />
								...
								<table>
									...
									<s:iterator value="#session.listHotelsDelete" var="currentHotel">
									<tr>
										<td><input type="checkbox" name="hotels" value="<s:property value="#currentHotel.id"/>" id="<s:property value="#currentHotel.id"/>"/></td>
									    <td><s:property value="#currentHotel.description"/></td>
										<td><s:property value="#currentHotel.address"/></td>
										<td>
											<!-- Icons -->
											 <a href="hotelsDelete.action?id=<s:property value="#currentHotel.id"/>&process=hotelsDelete" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a> 
										</td>
									</tr>
									</s:iterator>
	 ...
	 <%
	   out.write("Llamada ilegal del modulo Baja de hotel");
	 %>
</s:if>

...
<s:if test="#session.beanUser != null"> 
	...
	<body class="bodyMenu"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<h1 id="sidebar-title"><a href="#">Trip</a></h1>
		  
			<!-- Logo (221px wide) -->
			<a href="#"><img id="logo" src="resources/images/logo.png" alt="Trip" /></a>
					...
					<ul>  
						...
						<s:iterator value="#session.processList" var="processUsers">
							...
							<s:if test="#processType.id == id_process.id_type_process.id">
							 ...
							 <a href="/trip/pre.jsp?process=<s:property value="id_process.action"/>&action=<s:property value="id_process.url"/>" target="<s:property value="id_process.target"/>"><s:property value="id_process.description"/></a>

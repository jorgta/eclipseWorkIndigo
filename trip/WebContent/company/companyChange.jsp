...
<s:if test="#session.module == 'pre'"> 
	...
	<body class="bodyMain"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2></h2>
			<p id="page-intro">Alta de Usuarios</p>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<s:if test="#session.beanCompany2Change != null"> 
						...
						<li><a href="#tab2" >Compañia</a></li>	
						
					</s:if>
					<s:else>
					    <li><a href="#tab1" >Compañia</a></li> <!-- href must be unique and match the id of target div -->
						<li><a href="#tab2"  class="default-tab"> Compañias Registrados</a></li>	
						...
						<form action="companyChange" method="post" enctype="multipart/form-data">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									...
									<s:if test="fieldErrors['full_name'] != null">
									  <s:if test="#session.beanCompany2Change != null">									
										<s:textfield id="full_name" name="full_name" cssClass="text-input small-input" />
									 </s:if>
									 <s:else>
										<s:textfield id="full_name" name="full_name" cssClass="text-input small-input" />
									 </s:else>
										<span class="input-notification error png_bg" ><s:property value="fieldErrors.get('full_name').get(0)"/></span>
									</s:if>
									<s:else>
									<s:textfield id="full_name" name="full_name" cssClass="text-input small-input" value="%{#session.beanCompany2Change.full_name}" />
									</s:else>
								...
								<p>
									...
									<s:if test="fieldErrors['address'] != null">
									  <s:if test="#session.beanCompany2Change != null">									
										<s:textfield id="address" name="full_name" cssClass="text-input small-input" />
									 </s:if>
									 <s:else>
								...
								<p>
									...
									<s:if test="fieldErrors['rfc'] != null">
									  <s:if test="#session.beanCompany2Change != null">									
										<s:textfield id="rfc" name="rfc" cssClass="text-input small-input" />
									 </s:if>
									 <s:else>
										<s:textfield id="rfc" name="rfc" cssClass="text-input small-input" />
									 </s:else>
										<span class="input-notification error png_bg" ><s:property value="fieldErrors.get('rfc').get(0)"/></span>
									</s:if>
									<s:else>
									<s:textfield id="rfc" name="rfc" cssClass="text-input small-input" value="%{#session.beanCompany2Change.rfc}" />
									</s:else>
								</p>

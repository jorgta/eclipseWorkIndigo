...
import com.bituos.lca.forms.UserDeleteForm;
				...
				try
				  {
	                ...
	                {
	                	com.bituos.Error e = new com.bituos.Error("Este usuaario no puede ser borrado, Pues es el usuario actual", request);
	                	httpSession.setAttribute("done", new String("pre.do?process='userDelete'"));

...
public class DoctorDeleteAction extends Action {
	...
	public ActionForward execute(
		...
		// return value
		DoctorDeleteForm dataForm = (DoctorDeleteForm) form;
		...
		if ( beanUser == null )
		...
		else
		  {
			...
			try {
				...
				httpSession.setAttribute("done", new String("pre.jsp?&process='doctorDelete'&action='pre.do'&target=''"));

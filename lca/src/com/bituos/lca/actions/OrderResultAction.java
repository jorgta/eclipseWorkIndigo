...
public class OrderResultAction extends Action {
	int id = 0;
	...
	public ActionForward execute(
		...
		OrderResultForm dataForm = (OrderResultForm) form;
				...
				if ( dataForm.getProcess().equals("selectOrder") )
				  {
				    ...
				    if ( !list.isEmpty() )
					  ...
					  {
						com.bituos.Error e = new com.bituos.Error("La orden no existe o ya esta finalizada", request);

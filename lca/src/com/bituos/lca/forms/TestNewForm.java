 ...
 * @author
 */
public class TestNewForm extends ActionForm {
	...
	private String id_test_to_replicate = null; 
	private String test_name_to_replicate = null;	
	...
	private String id_parameter_limit = null;
	...
	public void reset(ActionMapping mapping, HttpServletRequest request) {
		...
		test_parameter_is_free_text = null;	
	...
	public ActionErrors validate(
		...
		if ( test_parameter_is_free_text == null )
		  {
			test_parameter_is_free_text = "off";
		  }
		...
		else if ( process.equals( "testReplicate" ) )
		  {
			if ( test_name_to_replicate != null )
			  {
				test_name_to_replicate = test_name_to_replicate.trim().toUpperCase();
				if (test_name_to_replicate.length() == 0)
					errors.add("test_name_to_replicate", new org.apache.struts.action.ActionError("error.field.required"));
			  }
			else
			  errors.add("test_name_to_replicate", new org.apache.struts.action.ActionError("error.field.required"));
	...
	public String getId_parameter_limit() {
		return id_parameter_limit;
	}

	public void setId_parameter_limit(String id_parameter_limit) {
		this.id_parameter_limit = id_parameter_limit;
	}

	public String getTest_name_to_replicate() {
		return test_name_to_replicate;
	}

	public void setTest_name_to_replicate(String test_name_to_replicate) {
		this.test_name_to_replicate = test_name_to_replicate;
	}

	public String getId_test_to_replicate() {
		return id_test_to_replicate;
	}

	public void setId_test_to_replicate(String id_test_to_replicate) {
		this.id_test_to_replicate = id_test_to_replicate;
	}

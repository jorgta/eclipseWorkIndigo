...
import com.bituos.lca.Beans.BeanControlPanel;
				...
				try
				  {
					...
					send( control_panel.getEmail_smtp_server(),
							  "80",
							  control_panel.getEmail_is_secure(), 
							  control_panel.getEmail_username(), 
							  control_panel.getEmail_password(),
		   					  toAddress,
		   					  "", 
		   					  "", 
		   					  subject,
...
//		 Si requiere o no usuario y password para conectarse.
	...
	props.setProperty("mail.smtp.from", "dsa@bituos.com");

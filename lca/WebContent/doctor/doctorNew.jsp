            ...
            <html:form action="/doctorNew" enctype="multipart/form-data" >
               <table ALIGN="CENTER" border="0" style="width: 50%;">
				...
				<TR>
					...
					<TD><html:text property="name" size="50"></html:text></TD>
		        	<TD> <FONT COLOR="RED"> <html:errors property="name"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.address" /></TD>
					<TD><html:text property="address" size="50"></html:text></TD>					
				...
				<TR>
					...
					<TD><html:textarea property="notes" cols="50" rows="10" /></TD>					
				...
				<TR>
					...
					<TD><html:text property="phone_cel"></html:text></TD>					

...
<html:html>
<head>
	<title>Seleccionar Configuración</title>
...
if(confirm("Esta seguro que quire borrar este registro?"))
{
...
<div class="x-blue_dg_caption"> <bean:message key="label.configurations.list" />  </div><p></p>

  
	         <html:form action="/truckTireConfigurationDeleteOrEdit">
			...
			<tbody>
			<tr>
			<td align="left"><b><a class="x-blue_dg_a_header" href="pre.jsp?&process='truckTireConfigurationNew'&action='pre.do'&target=''" title="Agregar Nuevo Vehículo">+ Add New</a></b></td>
			</tr>
			</tbody>
			</table>
			...
			%>
			  ...
			  <script type="text/javascript">
				//<![CDATA[
				var theForm = document.forms['truckTireConfigurationDeleteOrEditForm'];

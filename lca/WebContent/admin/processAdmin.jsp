...
<HEAD>
	...
	<LINK href="/lca/theme/Master.css" rel="stylesheet" type="text/css">
...
<table align="center">
							<tr>
								<td>									
		      						<html:button property="finish" onclick="location='/lca/main.jsp';"> <bean:message key="label.finish" /> </html:button>
								</td>
							</tr>
</table>
		  </logic:present>

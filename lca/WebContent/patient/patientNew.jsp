...
function FAjax(url,metodo,parameters)
{
	   var ajax=creaAjax();
		...
		if(metodo.toUpperCase()=='POST'){
			...
			<html:form action="/patientNew" enctype="multipart/form-data">
			 <html:hidden property="process" value=""/>
			 <table ALIGN="CENTER" border="0" style="width: 80%;">
				<TR bgcolor="lightblue">
				<td colspan="3" align="center" >					 
				 <div class="x-blue_dg_caption"> <bean:message key="label.patient.new" />   </div>					 
				</td>
				</TR>
				<tr>
				<td colspan="3">
				...
				<TR>
					<TD><bean:message key="label.patient.name" /></TD>
					<TD><html:text size="60" property="name"></html:text></TD>
		        	<TD> <FONT COLOR="RED"> <html:errors property="name"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.patient.street" /></TD>
					<TD><html:text size="60" property="street"></html:text></TD>					
		        	<TD> <FONT COLOR="RED"> <html:errors property="street"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.patient.external_number" /></TD>
					<TD><html:text property="external_number"></html:text></TD>						
		        	<TD> <FONT COLOR="RED"> <html:errors property="external_number"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.patient.city" /></TD>
					<TD><html:text property="city"></html:text></TD>							
		        	<TD> <FONT COLOR="RED"> <html:errors property="city"/></FONT> 
				</TR>
				<TR>
				<TD><bean:message key="label.patient.notes" /></TD>
					<TD><html:textarea property="notes" cols="50" rows="10" ></html:textarea></TD>					
		        	<TD> <FONT COLOR="RED"> <html:errors property="notes"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.patient.ship_street" /></TD>
					<TD><html:text size="60" property="ship_street"></html:text></TD>
		        	<TD> <FONT COLOR="RED"> <html:errors property="ship_street"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.patient.ship_external_number" /></TD>
					<TD><html:text size="10" property="ship_external_number"></html:text></TD>
		        	<TD> <FONT COLOR="RED"> <html:errors property="ship_external_number"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.patient.ship_city" /></TD>
					<TD><html:text property="ship_city"></html:text></TD>
		        	<TD> <FONT COLOR="RED"> <html:errors property="ship_city"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.patient.email" /></TD>
					<TD><html:text property="email"></html:text></TD>
		        	<TD> <FONT COLOR="RED"> <html:errors property="email"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.patient.discount" /></TD>
					<TD><html:text property="discount"></html:text></TD>
		        	<TD> <FONT COLOR="RED"> <html:errors property="discount"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.age" /></TD>
					<TD><html:text property="age"></html:text></TD>
		        	<TD> <FONT COLOR="RED"> <html:errors property="age"/></FONT> 
				</TR>
				<TR>
				...
				<TR>
					<TD><bean:message key="label.answer.is_male" /></TD>
					<TD>
		  			   <html:checkbox property="is_male" ></html:checkbox>
					 </TD>					
					<TD></TD>
				</TR>				
			...
			<CENTER><P><button class="button icon add" type="submit"  ><bean:message key="label.register" /></button> </P></CENTER>		

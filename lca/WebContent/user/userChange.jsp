...
<HEAD>
	...
	<META http-equiv="Content-Style-Type" content="text/css">
		...
		<link href="/truckAdmin/GridViewCSSThemes/YahooGridView.css" rel="stylesheet" type="text/css" />
		  ...
		  <logic:present name="processList" scope="session">
			...
			<TABLE border="0" ALIGN="CENTER">
				<TBODY>
					...
					<%  BeanBranch beanBranch = (BeanBranch) ses.getAttribute( "beanBranch" ); %>
					<TR>					
					<TD><bean:message key="label.branch" /></TD>
					<TD>
					    <html:select property="id_branch">
							<logic:iterate id="id" indexId="indexId" name="listBranch" scope="session" >
							<OPTION value= <%="'"%><bean:write name="id" property="id" /><%="'"%>  
							<logic:equal name="id" property="id" value="<%=String.valueOf( beanBranch.getId() )%>"> 
							    				SELECTED
							 </logic:equal>>  <bean:write name="id" property="name" /> </OPTION>
						    </logic:iterate>
				  	    </html:select> 
				  	</TD>
					<TD></TD>

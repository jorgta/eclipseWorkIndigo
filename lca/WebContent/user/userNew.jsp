...
<BODY style=" padding:50px; background-image: url('spitxtr.jpg')">
	...
	<logic:present name="beanUser" scope="session">
		  ...
		  <logic:present name="processList" scope="session">
            ...
            <html:form action="/userNew" enctype="multipart/form-data" >
               <table ALIGN="CENTER" border="0" style="width: 50%;">
				<TR bgcolor="lightblue">
				<td colspan="3" align="center" >					 
				 <div class="x-blue_dg_caption"> <bean:message key="label.user.new" />   </div>					 
				</td>
				</TR>
				<tr>
				<td colspan="3">
				...
				<TR>
					...
					<TD><html:text size="60" property="address"></html:text></TD>					
		        	<TD> <FONT COLOR="RED"> <html:errors property="address"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.email" /></TD>
					<TD><html:text size="30" property="email"></html:text></TD>					

	   ...
	   var ajax=creaAjax();
		...
		if(metodo.toUpperCase()=='POST'){
			...
			<td colspan="5" align="center" >					 
			 <div class="x-blue_dg_caption">  <bean:message key="label.user.delete" />    </div>					 
			</td>
			</TR>
			...
			<td colspan="5">
		     ...
		     <tr>
			  <td>
				...
				<th class="x-blue_dg_th dg_center dg_nowrap" style="background-color:#fcfaf6;width:150px;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';" bgcolor="#fcfaf6"><a class="x-blue_dg_a_header" href="javascript:void('sort');"  title="Sort"><b><input title="Teclee aqui para buscar" type="text" id="search2" value=""  onkeyup="FAjax('data.jsp','POST','list=listUserDelete&field=name&value='+ this.value+ '&bean=BeanUser&module=userDelete&active=Y&currentUser=off');"/></b> </a></th>
			    <th class="x-blue_dg_th dg_center dg_nowrap" style="background-color:#fcfaf6;width:150px;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';" bgcolor="#fcfaf6"><a class="x-blue_dg_a_header" href="javascript:void('sort');"  title="Sort"><b><input title="Teclee aqui para buscar" type="text" id="search2" value=""  onkeyup="FAjax('data.jsp','POST','list=listUserDelete&field=address&value='+ this.value+ '&bean=BeanUser&module=userDelete&active=Y&currentUser=off');"/></b> </a></th>
				<th class="x-blue_dg_th dg_center dg_nowrap" style="background-color:#fcfaf6;width:150px;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';"><a class="x-blue_dg_a_header" href="javascript:void('sort');"  title="Sort"><b><input title="Teclee aqui para buscar" type="text" id="search3" value=""  onkeyup="FAjax('data.jsp','POST','list=listUserDelete&field=email&value='+ this.value+ '&bean=BeanUser&module=userDelete&active=Y&currentUser=off');"/></b> </a></th>
				...
				<% String cuStyleBackground="rgb(255, 255, 255)";
				   ...
				   int i=0;
				%>
				<logic:iterate id="id" indexId="indexId" name="listUserDelete" scope="session" >
				<%
...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
	...
	//<![CDATA[
	var theForm = document.forms['userDeleteForm'];

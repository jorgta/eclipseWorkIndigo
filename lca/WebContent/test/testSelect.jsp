	   ...
	   var ajax=creaAjax();
		...
		if(metodo.toUpperCase()=='POST'){
	        ...
	        return;
	            ...
	            <html:form action="/testSelect">
				<html:hidden property="process" value=""/>
				<html:hidden property="id_test" value=""/>
	               ...
	               <table ALIGN="CENTER" border="0" style="width: 100%;">
						...
						<logic:present name="testList" scope="session">					
						...
						<th class="x-blue_dg_th dg_left" style="background-color:#fcfaf6;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';" bgcolor="#fcfaf6"><a class="x-blue_dg_a_header" href="javascript:void('sort');" onclick="javascript:sp__doPostBack('sort','','&amp;sp_page_size=15&amp;sp_p=1&amp;sp_sort_field=2&amp;sp_sort_field_by=&amp;sp_sort_field_type=string&amp;sp_sort_type=asc');" title="Sort"><b><bean:message key="label.price" /></b> </a></th>
						<th class="x-blue_dg_th dg_center dg_nowrap" style="background-color:#fcfaf6;width:150px;" onmouseover="bgColor='#e4ecf7';" onmouseout="bgColor='#fcfaf6';"><a class="x-blue_dg_a_header" href="javascript:void('sort');" onclick="javascript:sp__doPostBack('sort','','&amp;sp_page_size=15&amp;sp_p=1&amp;sp_sort_field=5&amp;sp_sort_field_by=&amp;sp_sort_field_type=&amp;sp_sort_type=desc');" title="Sort"><b><bean:message key="label.method" /></b> </a></th>
						...
						<logic:iterate id="id" indexId="indexId" name="testList" scope="session" >
						<%
...
//<![CDATA[
var theForm = document.forms['testSelectForm'];
...
function DoRequest( eventArgument,value) {
   ...
   if(eventArgument == 'select')
	  {	 
	    
	   theForm.id_test.value = value; 

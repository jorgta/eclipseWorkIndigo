...
function FAjax(url,metodo,parameters)
{
	   var ajax=creaAjax();
		...
		if(metodo.toUpperCase()=='POST'){
			...
			<html:form action="/representativeNew" enctype="multipart/form-data">
			 <html:hidden property="process" value=""/>
			 <table ALIGN="CENTER" border="0" style="width: 80%;">
				<TR bgcolor="lightblue">
				<td colspan="3" align="center" >					 
				 <div class="x-blue_dg_caption"> <bean:message key="label.representative.new" />   </div>					 
				</td>
				</TR>
				<tr>
				<td colspan="3">
				...
				<TR>
					<TD><bean:message key="label.representative.name" /></TD>
					<TD><html:text property="name" size="70"></html:text></TD>
		        	<TD> <FONT COLOR="RED"> <html:errors property="name"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.representative.address" /></TD>
					<TD><html:text property="address" size="70"></html:text></TD>					
		        	<TD> <FONT COLOR="RED"> <html:errors property="address"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.representative.notes" /></TD>

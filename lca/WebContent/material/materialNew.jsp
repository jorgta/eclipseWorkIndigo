...
<BODY style=" padding:50px; background-image: url('spitxtr.jpg')">
	...
	<logic:present name="beanUser" scope="session">
		  ...
		  <logic:present name="processList" scope="session">
            ...
            <html:form action="/materialNew" enctype="multipart/form-data" >
               <table ALIGN="CENTER" border="0" style="width: 50%;">
				<TR bgcolor="lightblue">
				<td colspan="3" align="center" >					 
				 <div class="x-blue_dg_caption"> <bean:message key="label.new.material" />   </div>					 
				</td>
				</TR>
				<tr>
				<td colspan="3">
				...
				<TR>
					<TD><bean:message key="label.haslabel" /></TD>
					<TD><html:checkbox property="haslabel"></html:checkbox>   </TD>
		        	<TD> <FONT COLOR="RED"> <html:errors property="haslabel"/></FONT> 
				</TR>
				<TR>
					<TD><bean:message key="label.active" /></TD>
					<TD><html:checkbox property="active"></html:checkbox>   </TD>
		        	<TD> <FONT COLOR="RED"> <html:errors property="active"/></FONT> 
				</TR>

...
le ofrece la solución para solicitar ayuda, simplemente con  presionar un botón y podrá comunicar su emergencia a nuestros             operadores, quienes harán los     enlaces con las personas            allegadas y a los servicios de  emergencia que usted requiera.
</p>
                        <a href="#">Leer Mas</a>
            </div>
       ...
       <div class="sliderleftcontent">
                    	...
                    	<p>Le ofrece la solución para solicitar ayuda, simplemente con  presionar un botón y podrá comunicar su emergencia a nuestros             operadores, quienes harán los     enlaces con las personas            allegadas y a los servicios de  emergencia que usted requiera.</p>
                        <a href="#">Leer Mas</a>
                    </div>
       ...
       <div class="sliderleftcontent">
                    	...
                    	<p>Vivir independiente es el deseo de la mayoría de nosotros, aunque ello implica  riesgos. Sobretodo  en  situaciones de emergencia, que de no atenderse de inmediato podrían     terminar en tragedia.</p>
                        <a href="#">Leer Mas</a>
                    </div>
       ...
       <div class="sliderleftcontent">
                    	<h2>El transmisor.</h2>
                    	<p>(por el cual puede   hablar y escuchar) cubre una casa promedio desde el frente hasta el patio, cuenta con batería de respaldo recargable.</p>
                        <a href="#">Leer Mas</a>
                    </div>
            	...
            	<div id="bodycontent">
                	<div id="bodyleftcontent">
                    	<div id="welcomecontent">
                        	<h2>Central de Alarmas</h2>
                            	<p> Le ofrece la solución para solicitar ayuda, simplemente con  presionar un botón y podrá comunicar su emergencia a nuestros operadores, quienes harán los enlaces con las personas allegadas y a los servicios de  emergencia que usted requiera.
 ...
 tristique senectus et netus et malesuada fames--> <a href="#">Leer mas</a></p>
                        ...
                        <div id="featuredservice">
                            ...
                            <ul class="services">
								...
								El transmisor (por el cual puede   hablar y escuchar) cubre una casa promedio desde el frente hasta el patio, cuenta con batería de respaldo recargable. 
                 ...
                 <!--       <form action="#">
                        ...
                        <h2><span>&nbsp;</span>Atención y seguridad para:</h2>
                            <ul class="news">
                                ...
                                <li><a href="#"><span>*</span> Convalecencia</a></li>
                                <li><a href="#"><span>*</span> Prevención de riesgos</a></li>                               
                        ...
                        <div class="testimonial">
                          ...
                          <hr style="width:245px; float:left; margin:0 10px; color:#fff;background-color:#fff; height:1px; border:none;">
							...
							28 años de experiencia en el ramo de monitoreo nos respaldan
